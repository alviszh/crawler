 ...
 */
@Entity
@Table(name = "insurance_luohe_medical" ,indexes = {@Index(name = "index_insurance_luohe_medical_taskid", columnList = "taskid")})
public class InsuranceLuoheMedical extends IdEntity implements Serializable {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = -53205359272376191L;
	...
	public InsuranceLuoheMedical(String taskid, String plan_month, String impose_month, String pay_num, String dw_pay,
