...
public class FunctionCallParam {
	...
	private IecmsParam iecmsParam;//
	
	public IecmsParam getIecmsParam() {
		return iecmsParam;
	}

	public void setIecmsParam(IecmsParam iecmsParam) {
		this.iecmsParam = iecmsParam;
	}
	...
	public String toString() {
		return "FunctionCallParam [function=" + function + ", webEngineParam="
				...
				+ ", iecmsParam=" + iecmsParam + ", creditchinaParam="
				+ creditchinaParam + ", customsParam=" + customsParam
