...
@DynamicUpdate(true)
@DynamicInsert
@Table(name = "housing_taian_userinfo")
public class HousingTaianUserInfo extends IdEntity {
	...
	public HousingTaianUserInfo(String taskid, String name, String bank, String idNum, String staffAccount,
