...
//		String imageUrl= "http://www.qjzfgjj.com/website/trans/InmageCreat.jsp"; 
...
//		outStream.close();
		...
		HtmlTextInput username = (HtmlTextInput)page2.getFirstByXPath("//input[@id='loginname']");
		
	
		HtmlPasswordInput password = (HtmlPasswordInput)page2.getFirstByXPath("//input[@id='loginpwd']");	
		//HtmlTextInput code = (HtmlTextInput)page2.getFirstByXPath("//input[@name='verify']");		
		HtmlElement button = (HtmlElement)page2.getFirstByXPath("//input[@id='submit']");
//		@SuppressWarnings("resource")
//		Scanner scanner = new Scanner(System.in);
//		String input = scanner.next();
		username.setText("330721198807274225");
		//YaF67tIlQnwkZ6RqSolTQ936Rx1FCQOE4N2Wnq50wx9TWOCFd6pWNNo2wNg1+wDc167lMK7H8Ik6F/f+9hpjFWcL11ZHPta4e+h1EuFCXgsyZqVCR8kf4tqnRfJxRi3/Vh6i+DG4m3Zh8IyhXO1jrpaPMgO2uBCUmGQhLy7dZdU=
		password.setText("zxx13757960257");
		HtmlPage loggedPage = button.click();
		System.out.println("登陆成功后的页面  ====》》"+loggedPage.asXml());
		
//		
//	    String loginUrl4 = "http://www.qjzfgjj.com/website/website.do?className=TRA020001";		                     
//		WebRequest webRequest4 = new WebRequest(new URL(loginUrl4), HttpMethod.POST);	
//		//
//		List<NameValuePair> paramsList = new ArrayList<NameValuePair>();
//		paramsList.add(new NameValuePair("stxt", "1"));
...
////		Set<Cookie> cookies = page4.getWebClient().getCookieManager().getCookies();
