...
@Entity
@Table(name="insurance_tianjin_maternity",indexes = {@Index(name = "index_insurance_tianjin_maternity_taskid", columnList = "taskid")}) 
public class InsuranceTianjinMaternity extends IdEntity{
