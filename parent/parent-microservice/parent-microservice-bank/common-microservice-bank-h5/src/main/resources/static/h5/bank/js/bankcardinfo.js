function bankCardAttribution(bankCard){
  ...
  var bankcardList = [{
    ...
    patterns: [{
      ...
      reg: /^(356885|356886|356887|356888|356890|439188|439227|479228|479229|521302|356889|545620|545621|545947|545948|552534|552587|622575|622576|451461|622577|622578|622579|545619|622581|622582|545623|628290|439225|518710|518718|628362|439226|628262|625802|625803)\d{10}$/g,
      cardType: "CC"
    }, {
    ...
    for (var i = 0, len = bankcardList.length; i < len; i++) {
      ...
      for (var j = 0, jLen = patterns.length; j < jLen; j++) {
        ...
        if ((new RegExp(pattern.reg)).test(cardNo)) {
          ...
          if(info['bankName'].indexOf($('#bankType').val())!=-1){
          ...
          else if(info['bankName'].indexOf($('#bankType').val())==-1&&info['bankName'].indexOf('银行')!=-1){
            //$('#cofModal').modal('show');
            //$('#confMbc').text(info['bankName']);
            //$('#confDc').text(info['cardTypeName']);
          }
          return info;
          console.log(1);
          console.log(info)
