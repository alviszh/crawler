...
import app.service.HousingFundZhanJiangCommonService;

@RestController
@Configuration
@RequestMapping("/housing/zhanjiang")
public class HousingFundZhanJiangController extends HousingBasicController{

	@Autowired
	private HousingFundZhanJiangCommonService housingFundZhanJiangCommonService;
	@Autowired
...
//			save(taskHousing);
			...
			housingFundZhanJiangCommonService.login(messageLoginForHousing);
...
//			save(taskHousing);
			...
			housingFundZhanJiangCommonService.getAllData(messageLoginForHousing);
