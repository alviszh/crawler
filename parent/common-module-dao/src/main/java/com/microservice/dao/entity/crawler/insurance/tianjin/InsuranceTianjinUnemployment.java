...
@Entity
@Table(name="insurance_tianjin_unemployment",indexes = {@Index(name = "index_insurance_tianjin_unemployment_taskid", columnList = "taskid")}) 
public class InsuranceTianjinUnemployment extends IdEntity{
