...
@DynamicUpdate(true)
@DynamicInsert
@Table(name="maimai_user_educations",indexes = {@Index(name = "index_maimai_user_educations_taskid", columnList = "taskid")})
public class MaimaiUserEducations extends IdEntity{
	...
	public String toString() {
		return "MaimaiUserEducations [taskid=" + taskid + ", mm_id=" + mm_id + ", school=" + school
