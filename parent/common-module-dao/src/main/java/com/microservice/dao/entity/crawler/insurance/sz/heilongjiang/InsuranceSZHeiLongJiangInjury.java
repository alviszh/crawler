...
@Entity
@Table(name="insurance_sz_heilongjiang_injury",indexes = {@Index(name = "index_insurance_sz_heilongjiang_injury_taskid", columnList = "taskid")}) 
public class InsuranceSZHeiLongJiangInjury extends IdEntity{
