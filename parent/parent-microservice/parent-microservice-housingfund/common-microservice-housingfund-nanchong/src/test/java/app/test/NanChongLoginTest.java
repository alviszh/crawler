...
public class NanChongLoginTest {
	public static void main(String[] args) {
		try {
			String loginUrl="https://wsyw.nczfgjj.com:7083/wt-web/login";
...
//				loginUrl="https://wsyw.nczfgjj.com:7083/wt-web/login";
				loginUrl="https://wsyw.nczfgjj.com:7083/wt-web/login;jsessionid=72565812D02D12F30C911089A906A216";
				webRequest = new WebRequest(new URL(loginUrl), HttpMethod.POST);
				String requestBody="username=511302198704072325&password=0896c631b1c4c726fd2f24d376bda9d1&captcha="+code+"&logintype=1";
				...
				if(null!=logonPage){
					...
					if(html.contains("欢迎您")){
						...
						//将个人基本信息表的pdf保存到本地
						String url="https://wsyw.nczfgjj.com:7083/wt-web/grxxpdf/grxx";
