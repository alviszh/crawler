 ...
 */
@Entity
@Table(name="insurance_ningbo_html",indexes = {@Index(name = "index_insurance_ningbo_html_taskid", columnList = "taskid")}) 
public class InsuranceNingboHtml extends IdEntity{
