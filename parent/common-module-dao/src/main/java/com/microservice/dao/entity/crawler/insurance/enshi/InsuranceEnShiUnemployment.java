...
@Entity
@Table(name="insurance_enshi_unemployment",indexes = {@Index(name = "index_insurance_enshi_unemployment_taskid", columnList = "taskid")})
public class InsuranceEnShiUnemployment extends IdEntity{
	...
	public String toString() {
		return "InsuranceEnShiUnemployment [personalNum=" + personalNum + ", inDate=" + inDate + ", moneyType="
				+ moneyType + ", payType=" + payType + ", base=" + base + ", payNow=" + payNow + ", personalMoney="
				+ personalMoney + ", getFlag=" + getFlag + ", getDate=" + getDate + ", sendFlag=" + sendFlag
				+ ", taskid=" + taskid + "]";
	}
