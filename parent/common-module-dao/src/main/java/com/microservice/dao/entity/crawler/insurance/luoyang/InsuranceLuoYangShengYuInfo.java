...
@Entity
@Table(name = "insurance_luoyang_shengyuinfo",indexes = {@Index(name = "index_insurance_luoyang_shengyuinfo_taskid", columnList = "taskid")})
public class InsuranceLuoYangShengYuInfo extends IdEntity implements Serializable{
	...
	public InsuranceLuoYangShengYuInfo(String taskid, String abstracts, String total, String pay_num, String gr_pay,
	...
	public InsuranceLuoYangShengYuInfo() {
		super();
	}
	@Override
