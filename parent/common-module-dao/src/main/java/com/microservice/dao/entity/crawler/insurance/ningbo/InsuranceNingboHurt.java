...
@Entity
@Table(name="insurance_ningbo_hurt",indexes = {@Index(name = "index_insurance_ningbo_hurt_taskid", columnList = "taskid")}) 
public class InsuranceNingboHurt extends IdEntity{
	...
	public String toString() {
		return "InsuranceNingboHurt [taskid=" + taskid + ", payDate=" + payDate + ", insuranceBase=" + insuranceBase
