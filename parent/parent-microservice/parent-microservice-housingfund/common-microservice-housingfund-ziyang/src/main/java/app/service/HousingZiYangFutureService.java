...
public class HousingZiYangFutureService extends HousingBasicService implements ICrawlerLogin,ICrawler{
	public static final Logger log = LoggerFactory.getLogger(HousingZiYangFutureService.class);

	@Autowired
	private LoginAndGetService loginAndGetService;
	@Autowired
	private HousingZiYangService housingZiYangService;
	...
	public TaskHousing login(MessageLoginForHousing messageLoginForHousing) {
		...
		String url = "http://www.zygjj.com:8012/ispobs/";
		Page htmlpage = null;
		try {
...
//			tracer.addTag("e", "baotougangjijin");
		...
		if(htmlpage!=null){
			...
			if(htmlpage.getWebResponse().getContentAsString().contains("登录成功")){
...
//			tracer.addTag("e", "baotougangjijin");
	...
	public TaskHousing getAllData(MessageLoginForHousing messageLoginForHousing) {
		...
		try {
			Future<String> future = housingZiYangService.getResult(messageLoginForHousing, taskHousing, webClient);
		} catch (Exception e) {
