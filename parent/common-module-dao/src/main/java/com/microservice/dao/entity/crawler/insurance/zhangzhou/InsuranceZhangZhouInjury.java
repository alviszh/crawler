...
@Entity
@Table(name="insurance_zhangzhou_injury",indexes = {@Index(name = "index_insurance_zhangzhou_injury_taskid", columnList = "taskid")})
public class InsuranceZhangZhouInjury extends IdEntity{
