...
import app.service.HousingFundDezhouService;



@RestController  
@Configuration
@RequestMapping("/housing/dezhou")
public class HousingFundDezhouController extends HousingBasicController{
	
	@Autowired
	private TracerLog tracer;
	@Autowired
	private   HousingFundDezhouService HousingFundDezhouService;
	...
	public ResultData<TaskHousing> housingFundCrawler(@RequestBody MessageLoginForHousing messageLoginForHousing) {
		...
		save(taskHousing);
		HousingFundDezhouService.crawler(messageLoginForHousing, taskHousing);
