...
@Entity
@Table(name = "insurance_jiyuan_yanglaoinfo",indexes = {@Index(name = "index_insurance_jiyuan_yanglaoinfo_taskid", columnList = "taskid")})
public class InsuranceJiYuanYangLaoInfo extends IdEntity implements Serializable{
	...
	public InsuranceJiYuanYangLaoInfo(String taskid, String abstracts, String total, String pay_num, String gr_pay,
	...
	public InsuranceJiYuanYangLaoInfo() {
		super();
	}
	@Override
