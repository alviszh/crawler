...
@Entity
@Table(name="insurance_maoming_injury",indexes = {@Index(name = "index_insurance_maoming_injury_taskid", columnList = "taskid")})
public class InsuranceMaoMingInjury extends IdEntity{
