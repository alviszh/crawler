 ...
 */
@Entity
@Table(name = "insurance_chengdu_unemployment" ,indexes = {@Index(name = "index_insurance_chengdu_unemployment_taskid", columnList = "taskid")})
public class InsuranceChengduUnemployment extends IdEntity{
	...
	public String toString() {
		return "InsuranceChengduUnemployment [taskid=" + taskid + ", payMonth=" + payMonth + ", company=" + company
	...
	public InsuranceChengduUnemployment(String taskid, String payMonth, String company, String payBase,
			String companyPay, String personalPay, String companyProportion, String personnelProportion,
	...
	public InsuranceChengduUnemployment() {
		super();
