...
@Entity
@Table(name = "insurance_jiaozuo_shengyuinfo",indexes = {@Index(name = "index_insurance_jiaozuo_shengyuinfo_taskid", columnList = "taskid")})
public class InsuranceJiaoZuoShengYuInfo extends IdEntity implements Serializable{
	...
	public InsuranceJiaoZuoShengYuInfo(String category, String unit, String time, String base, String sign,
	...
	public InsuranceJiaoZuoShengYuInfo() {
		super();
	}
	@Override
	public String toString() {
		return "InsuranceJiaoZuoShengYuInfo [category=" + category + ", unit=" + unit + ", time=" + time + ", base="
