...
import app.service.HousingFundZhangzhouService;



@RestController  
@Configuration
@RequestMapping("/housing/zhangzhou")
public class HousingFundZhangzhouController extends HousingBasicController{
	
	@Autowired
	private TracerLog tracer;
	@Autowired
	private   HousingFundZhangzhouService housingFundZhangzhouService;
	...
	public ResultData<TaskHousing> housingFundLogin(@RequestBody MessageLoginForHousing messageLoginForHousing) throws Exception {
		...
		tracer.addTag("action.housingFund.zhangzhou.login.start",messageLoginForHousing.getTask_id());
		...
		housingFundZhangzhouService.login(messageLoginForHousing, taskHousing);
	...
	public ResultData<TaskHousing> housingFundCrawler(@RequestBody MessageLoginForHousing messageLoginForHousing) {
		...
		save(taskHousing);
		housingFundZhangzhouService.crawler(messageLoginForHousing, taskHousing);
		result.setData(taskHousing);
		return result;
	}
