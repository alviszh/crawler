...
public class WebParam<T> {
	...
	public HousingQiqihaerAccount housingQiqihaerAccount;
	...
	public HousingQiqihaerAccount getHousingQiqihaerAccount() {
		return housingQiqihaerAccount;
	}

	public void setHousingQiqihaerAccount(HousingQiqihaerAccount housingQiqihaerAccount) {
		this.housingQiqihaerAccount = housingQiqihaerAccount;
	}
