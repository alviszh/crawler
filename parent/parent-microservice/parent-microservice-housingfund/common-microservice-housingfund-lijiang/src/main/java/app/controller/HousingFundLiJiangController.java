...
import app.service.HousingFundLiJiangService;

@RestController
@Configuration
@RequestMapping("/housing/lijiang")
public class HousingFundLiJiangController extends HousingBasicController{

	@Autowired
	private HousingFundLiJiangService housingFundLiJiangService;
	@Autowired
...
//			save(taskHousing);
			...
			housingFundLiJiangService.login(messageLoginForHousing);
...
//			save(taskHousing);
			...
			housingFundLiJiangService.getAllData(messageLoginForHousing);
