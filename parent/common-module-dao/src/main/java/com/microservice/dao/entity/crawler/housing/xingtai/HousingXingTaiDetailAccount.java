...
/**
 * @description: 邢台市公积金明细账信息
 * @author: sln
 * @date:
 */
@Entity
@Table(name = "housing_xingtai_detailaccount",indexes = {@Index(name = "index_housing_xingtai_detailaccount_taskid", columnList = "taskid")})
public class HousingXingTaiDetailAccount extends IdEntity implements Serializable {
...
//	余额
	...
	public HousingXingTaiDetailAccount() {
		super();
