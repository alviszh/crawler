...
@Entity
@Table(name = "insurance_jiyuan_yiliaoinfo",indexes = {@Index(name = "index_insurance_jiyuan_yiliaoinfo_taskid", columnList = "taskid")})
public class InsuranceJiYuanYiLiaoInfo extends IdEntity implements Serializable{
	...
	public InsuranceJiYuanYiLiaoInfo(String taskid, String abstracts, String total, String pay_num, String gr_pay,
	...
	public InsuranceJiYuanYiLiaoInfo() {
		super();
	}
	@Override
