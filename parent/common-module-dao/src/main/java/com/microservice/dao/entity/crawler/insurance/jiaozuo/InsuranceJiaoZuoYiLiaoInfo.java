...
@Entity
@Table(name = "insurance_jiaozuo_yiliaoinfo",indexes = {@Index(name = "index_insurance_jiaozuo_yiliaoinfo_taskid", columnList = "taskid")})
public class InsuranceJiaoZuoYiLiaoInfo extends IdEntity implements Serializable{
	...
	public InsuranceJiaoZuoYiLiaoInfo(String category, String unit, String time, String base, String sign,
	...
	public InsuranceJiaoZuoYiLiaoInfo() {
		super();
	}
	@Override
	public String toString() {
		return "InsuranceJiaoZuoYiLiaoInfo [category=" + category + ", unit=" + unit + ", time=" + time + ", base="
