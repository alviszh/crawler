...
public class HousingFundXuzhouService extends HousingBasicService{

	@Autowired
	private HousingFundXuzhouCommonService housingFundXuzhouCommonService;

	public void crawler(MessageLoginForHousing messageLoginForHousing, TaskHousing taskHousing) {
		housingFundXuzhouCommonService.getAccountInfo(messageLoginForHousing, taskHousing);
		housingFundXuzhouCommonService.getDetail(messageLoginForHousing, taskHousing);
	}
