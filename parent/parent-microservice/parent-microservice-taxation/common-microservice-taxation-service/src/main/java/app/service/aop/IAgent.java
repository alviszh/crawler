...
public interface IAgent {
	 ...
	 */
	public void releaseInstance(String taxationIpAddr, WebDriver driver);
	 ...
	 *            登录的请求路径
	 */
	public TaskTaxation postAgent(TaxationRequestParameters taxationRequestParameters, String requestPath);
	 ...
	 *            登录的请求路径
	 */
	public TaskTaxation postAgentCombo(TaxationRequestParameters taxationRequestParameters, String requestPath);
}
