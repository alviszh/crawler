...
@Entity
@Table(name="pro_bank_report_debit_deposit",indexes = {@Index(name = "index_pro_bank_report_debit_deposit_taskid", columnList = "taskId")})

public class ProBankReportDebitDeposit extends IdEntity implements Serializable{
	...
	public String toString() {
		return "ProBankReportDebitDeposit [taskId=" + taskId + ", cardNum=" + cardNum + ", lastNum=" + lastNum
