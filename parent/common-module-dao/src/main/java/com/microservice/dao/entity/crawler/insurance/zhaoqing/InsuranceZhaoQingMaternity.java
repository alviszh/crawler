...
@Entity
@Table(name="insurance_zhaoqing_maternity",indexes = {@Index(name = "index_insurance_zhaoqing_maternity_taskid", columnList = "taskid")})
public class InsuranceZhaoQingMaternity extends IdEntity{
