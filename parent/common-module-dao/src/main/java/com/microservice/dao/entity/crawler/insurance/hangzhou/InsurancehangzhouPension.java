 ...
 */
@Entity
@Table(name="insurance_hangzhou_pension",indexes = {@Index(name = "index_insurance_hangzhou_pension_taskid", columnList = "taskid")})
public class InsurancehangzhouPension extends IdEntity{
