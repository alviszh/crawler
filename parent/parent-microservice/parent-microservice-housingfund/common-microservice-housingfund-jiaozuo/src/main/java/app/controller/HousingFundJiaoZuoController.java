...
import app.service.HousingFundJiaoZuoService;


@RestController  
@Configuration
@RequestMapping("/housing/jiaozuo")
public class HousingFundJiaoZuoController extends HousingBasicController{
	@Autowired
	private TracerLog tracer;
	@Autowired
	private HousingFundJiaoZuoService housingFundJiaoZuoService;
	...
	public ResultData<TaskHousing> housingFundLogin(@RequestBody MessageLoginForHousing messageLoginForHousing) throws Exception {
		...
		save(taskHousing);
//		
		housingFundJiaoZuoService.login(messageLoginForHousing, taskHousing);
	...
	public ResultData<TaskHousing> housingFundCrawler(@RequestBody MessageLoginForHousing messageLoginForHousing) {
		...
		save(taskHousing);
		housingFundJiaoZuoService.crawler(messageLoginForHousing, taskHousing);
		result.setData(taskHousing);
		return result;
	}
