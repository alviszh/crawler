...
public class JudicialWritParser {
	...
	public JudicialWritList getCrawler(JSONObject jsonObject, JudicialWritTask judicialWritTask, String runEval) throws Exception {
		...
		if(docId!=null){
			...
			if(StringUtils.isNotBlank(writid)){
				...
				judicialWritList = new JudicialWritList(judicialWritTask.getTaskid(),
