...
import app.service.HousingFundYuLinService;


@RestController  
@Configuration
@RequestMapping("/housing/yulin")
public class HousingFundYuLinController extends HousingBasicController{
	@Autowired
	private TracerLog tracer;
	@Autowired
	private HousingFundYuLinService housingFundYuLinService;
	...
	public ResultData<TaskHousing> housingFundCrawler(@RequestBody MessageLoginForHousing messageLoginForHousing) {
		...
		save(taskHousing);
		housingFundYuLinService.crawler(messageLoginForHousing, taskHousing);
