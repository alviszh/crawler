...
@Entity
@Table(name = "insurance_yulin_yanglao",indexes = {@Index(name = "index_insurance_yulin_yanglao_taskid", columnList = "taskid")})
public class InsuranceYuLinYangLao extends IdEntity implements Serializable{
	...
	public InsuranceYuLinYangLao(String taskid, String companyname, String settlement_period, String fkdate,
