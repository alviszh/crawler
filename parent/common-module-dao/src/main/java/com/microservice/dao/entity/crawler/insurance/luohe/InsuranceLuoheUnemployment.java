 ...
 */
@Entity
@Table(name = "insurance_luohe_unemployment" ,indexes = {@Index(name = "index_insurance_luohe_unemployment_taskid", columnList = "taskid")})
public class InsuranceLuoheUnemployment extends IdEntity implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -9186186339057273690L;
	...
	public InsuranceLuoheUnemployment(String taskid, String plan_month, String impose_month, String pay_num,
			String dw_pay, String gr_pay, String total, String write_gr, String pay_sign, String arrivetime,
			String dw_name, String dw_num, String abstracts) {
		super();
		this.taskid = taskid;
		this.plan_month = plan_month;
		this.impose_month = impose_month;
	...
	public InsuranceLuoheUnemployment() {
		super();
