...
@Entity
@Table(name="insurance_haikou_maternity",indexes = {@Index(name = "index_insurance_haikou_maternity_taskid", columnList = "taskid")})
public class InsuranceHaiKouMaternity extends IdEntity{
	...
	public String toString() {
		return "InsuranceHaiKouMaternity [company=" + company + ", status=" + status + ", datea=" + datea + ", base="
