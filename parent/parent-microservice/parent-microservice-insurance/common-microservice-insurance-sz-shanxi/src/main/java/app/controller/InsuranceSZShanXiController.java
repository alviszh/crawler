...
import app.service.InsuranceSZShanXiCommonService;
import app.service.InsuranceService;
import app.service.aop.InsuranceLogin;

@RestController  
@Configuration
@RequestMapping("/insurance/sz/shanxi")
public class InsuranceSZShanXiController {

	@Autowired
	private InsuranceSZShanXiCommonService insuranceSZShanXiCommonService;
	@Autowired
	...
	public TaskInsurance login(@RequestBody InsuranceRequestParameters insuranceRequestParameters){
		...
		tracer.addTag("InsuranceSZShanXiController login", insuranceRequestParameters.getTaskId());
		//通过taskid查出对应表中的数据
		TaskInsurance taskInsurance = taskInsuranceRepository.findByTaskid(insuranceRequestParameters.getTaskId());
//	    taskInsurance = insuranceService.changeLoginStatusDoing(taskInsurance);
//		try {
//			insuranceSZShanXiCommonService.login(insuranceRequestParameters,taskInsurance);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
	...
	public TaskInsurance crawler(@RequestBody InsuranceRequestParameters insuranceRequestParameters) throws Exception{
		...
		tracer.addTag("InsuranceSZShanXiController crawler", insuranceRequestParameters.getTaskId());
...
//		}else{
//			taskInsurance = insuranceService.changeLoginStatusDoing(taskInsurance);
//			insuranceSZShanXiCommonService.getAllData(insuranceRequestParameters,taskInsurance);	
//		}
