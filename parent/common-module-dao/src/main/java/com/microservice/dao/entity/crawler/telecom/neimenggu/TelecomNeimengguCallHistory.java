 ...
 */
@Entity
@Table(name="telecom_neimenggu_callhistory",indexes = {@Index(name = "index_telecom_neimenggu_callhistory_taskid", columnList = "taskid")})
public class TelecomNeimengguCallHistory  extends IdEntity{
	/** 爬取批次号 */
	@Column(name="taskid")
