...
@Entity
@Table(name="insurance_shaoxing_injury",indexes = {@Index(name = "index_insurance_shaoxing_injury_taskid", columnList = "taskid")}) 
public class InsuranceShaoXingInjury extends IdEntity{
