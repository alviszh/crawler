...
public class ShenyangTest {

	public static void main(String[] args) throws FailingHttpStatusCodeException, IOException {
		WebClient webClient = WebCrawler.getInstance().getNewWebClient();
		
		URL url  = new URL("http://218.28.166.74:8080/zzsbonline/login.jsp");
		...
		System.out.println(page.getWebResponse().getContentAsString(Charset.forName("utf8")));
