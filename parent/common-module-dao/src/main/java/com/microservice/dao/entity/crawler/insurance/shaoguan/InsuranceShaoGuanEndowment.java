...
@Entity
@Table(name="insurance_shaoguan_endowment",indexes = {@Index(name = "index_insurance_shaoguan_endowment_taskid", columnList = "taskid")})
public class InsuranceShaoGuanEndowment extends IdEntity{
