...
import app.service.InsuranceLuZhouCommonService;
import app.service.InsuranceService;
import app.service.aop.InsuranceLogin;

@RestController  
@Configuration
@RequestMapping("/insurance/luzhou")
public class InsuranceLuZhouController {

	@Autowired
	private InsuranceLuZhouCommonService insuranceLuZhouCommonService;
	@Autowired
...
//		try {
//			insuranceLuZhouCommonService.login(insuranceRequestParameters,taskInsurance);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
...
//		}else{
//			taskInsurance = insuranceService.changeLoginStatusDoing(taskInsurance);
//			insuranceLuZhouCommonService.getAllData(insuranceRequestParameters,taskInsurance);	
//		}
