...
public class CreditRecord implements Serializable {
	...
	private Map<String, String> guarantorCompensatoryinfoDetails; //保证人代偿信息   key:序号  value:内容
	private List<Map<String, Object>> parsedGuarantorCompensatoryinfoDetails; //被解析过的 保证人代偿信息
	...
	public Map<String, String> getGuarantorCompensatoryinfoDetails() {
		return guarantorCompensatoryinfoDetails;
	}
	public void setGuarantorCompensatoryinfoDetails(Map<String, String> guarantorCompensatoryinfoDetails) {
		this.guarantorCompensatoryinfoDetails = guarantorCompensatoryinfoDetails;
	}
	public List<Map<String, Object>> getParsedGuarantorCompensatoryinfoDetails() {
		return parsedGuarantorCompensatoryinfoDetails;
	}
	public void setParsedGuarantorCompensatoryinfoDetails(
			List<Map<String, Object>> parsedGuarantorCompensatoryinfoDetails) {
		this.parsedGuarantorCompensatoryinfoDetails = parsedGuarantorCompensatoryinfoDetails;
	}
	@Override
	public String toString() {
		return "CreditRecord [creditSummary=" + creditSummary + ", creditCardDetails=" + creditCardDetails
				+ ", parsedCreditCardDetails=" + parsedCreditCardDetails + ", housingLoanDetails=" + housingLoanDetails
				+ ", otherLoanDetails=" + otherLoanDetails + ", parsedLoanDetails=" + parsedLoanDetails
				+ ", guaranteeInfoDetails=" + guaranteeInfoDetails + ", parsedGuaranteeInfoDetails="
				+ parsedGuaranteeInfoDetails + ", guarantorCompensatoryinfoDetails=" + guarantorCompensatoryinfoDetails
				+ ", parsedGuarantorCompensatoryinfoDetails=" + parsedGuarantorCompensatoryinfoDetails + "]";
	}
