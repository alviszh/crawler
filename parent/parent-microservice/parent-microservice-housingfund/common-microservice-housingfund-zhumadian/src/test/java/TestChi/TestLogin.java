...
public class TestLogin {
	...
	public static void main(String[] args) throws Exception{
		String url="http://cfszfgjj.com/wt-web/login";
...
//		System.out.println(page2.getWebResponse().getContentAsString());
		...
		String url2="http://cfszfgjj.com/wt-web/personal/jcmxlist?UserId=1&beginDate=2015-01-01&endDate=2018-01-22&userId=1&pageNum=1&pageSize=50";
