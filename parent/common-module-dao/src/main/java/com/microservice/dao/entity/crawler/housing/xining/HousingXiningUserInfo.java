...
@DynamicUpdate(true)
@DynamicInsert
@Table(name = "housing_xining_userinfo")
public class HousingXiningUserInfo extends IdEntity {
	...
	public HousingXiningUserInfo(String taskid, String xingming, String csny, String xingbie, String zjlx, String zjhm,
