...
@Entity
@Table(name="housing_ziyang_userinfo",indexes = {@Index(name = "index_housing_ziyang_userinfo_taskid", columnList = "taskid")})
public class HousingZiYangUserInfo extends IdEntity implements Serializable{
	...
	public String toString() {
		return "HousingZiYangUserInfo [personalAccount=" + personalAccount + ", name=" + name + ", idCard=" + idCard
