...
public class CoderUtils {  
    ...
    public static void main(String[] args) throws IOException {  
        ...
        String s = "24191,35199,21338,20026,20154,21147,36164,28304,21672,35810,26381,21153,26377,38480,20844,21496";  
        showIntArray(string2ASCII(s), " ");  
        System.out.println();  
        System.out.println(ascii2String(string2ASCII(s)));  
  
        System.out.println(ascii2String(ascii2String(s)));  
