 ...
 */
@Entity
@Table(name="insurance_hangzhou_injury",indexes = {@Index(name = "index_insurance_hangzhou_injury_taskid", columnList = "taskid")})
public class InsuranceHangzhouInjury extends IdEntity{
	...
	public String toString() {
		return "InsuranceHangzhouInjury [taskid=" + taskid +", payMonth=" + payMonth 
