...
@DynamicUpdate(true)
@DynamicInsert
@Table(name = "housing_jiuquan_userinfo" ,indexes = {@Index(name = "index_housing_jiuquan_userinfo_taskid", columnList = "taskid")})
public class HousingJiuquanUserInfo extends IdEntity {
	...
	public HousingJiuquanUserInfo(String taskid, String xingming, String csny, String xingbie, String zjlx, String zjhm,
