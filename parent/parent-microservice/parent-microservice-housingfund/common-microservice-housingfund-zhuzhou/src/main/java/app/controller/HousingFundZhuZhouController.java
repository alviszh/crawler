...
import app.service.HousingFundZhuZhouCommonService;

@RestController
@Configuration
@RequestMapping("/housing/zhuzhou")
public class HousingFundZhuZhouController extends HousingBasicController{

	@Autowired
	private HousingFundZhuZhouCommonService housingFundZhuZhouCommonService;
	@Autowired
...
//			save(taskHousing);
			...
			housingFundZhuZhouCommonService.login(messageLoginForHousing);
...
//			save(taskHousing);
			...
			housingFundZhuZhouCommonService.getAllData(messageLoginForHousing);
