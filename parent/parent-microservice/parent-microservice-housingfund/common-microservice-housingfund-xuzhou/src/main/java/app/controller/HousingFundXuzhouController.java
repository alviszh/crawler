...
import app.service.HousingFundXuzhouService;

@RestController  
@Configuration
@RequestMapping("/housing/xuzhou")
public class HousingFundXuzhouController extends HousingBasicController{
	
	@Autowired
	private HousingFundXuzhouService housingFundXuzhouService;
	@Autowired
	...
	public ResultData<TaskHousing> housingFundLogin(@RequestBody MessageLoginForHousing messageLoginForHousing) throws Exception {
		...
		save(taskHousing);
//		
		housingFundXuzhouService.login(messageLoginForHousing, taskHousing);
	...
	public ResultData<TaskHousing> housingFundCrawler(@RequestBody MessageLoginForHousing messageLoginForHousing) {
		...
		housingFundXuzhouService.crawler(messageLoginForHousing, taskHousing);
