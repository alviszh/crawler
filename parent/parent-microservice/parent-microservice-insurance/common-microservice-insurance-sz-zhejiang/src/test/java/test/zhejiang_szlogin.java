...
//			code.setText(co);
		...
		username.setText("511602199408281123");
		password.setText("gyp1127");
...
//		geBirthUserinfo(webClient);
	...
	private static void getUserInfo(WebClient webClient ) throws Exception{
		...
		//String s = page.getWebResponse().getContentAsString("UTF-8");
		//System.out.println("\n获取城市==========>>>>\n" + s );
