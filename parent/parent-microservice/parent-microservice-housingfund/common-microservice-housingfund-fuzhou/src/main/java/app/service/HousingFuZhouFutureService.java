...
public class HousingFuZhouFutureService extends HousingBasicService implements ICrawlerLogin,ICrawler{
	public static final Logger log = LoggerFactory.getLogger(HousingFuZhouFutureService.class);
	
	@Autowired
	private LoginAndGetService loginAndGetService;
	@Autowired
	private HousingFuZhouService housingFuZhouService;
	@Async
	@Override
	public TaskHousing login(MessageLoginForHousing messageLoginForHousing) {
		...
		String url = "http://www.fzgjj.com.cn:7002/fznetface/login.jsp";
		Page htmlpage = null;
		try {
...
//			tracer.addTag("e", "baotougangjijin");
		...
		if(htmlpage!=null){
			...
			if(htmlpage.getWebResponse().getContentAsString().contains("true")){
