...
function diffProvinceHtml(){
    ...
    //显示温馨提示
    $("#prompt").append("<small class='form-text text-muted'>温馨提示：<br />*中国电信为保护客户隐私，需进行二次短信认证。<br />*中国电信短信验证码可能存在延迟或未发送情况，可以通过再次发送短信验证码重新获取<br />" +
        "*由于广西省电信网站不让频繁点击访问，所以爬取时间比较长，请耐心等待！<br /></small>");
