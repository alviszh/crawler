 ...
 */
@Entity
@Table(name="insurance_hangzhou_maternity",indexes = {@Index(name = "index_insurance_hangzhou_maternity_taskid", columnList = "taskid")})
public class InsuranceHangzhouMaternity extends IdEntity{
	...
	public String toString() {
		return "InsuranceHangzhouMaternity [taskid=" + taskid +", payMonth=" + payMonth 
