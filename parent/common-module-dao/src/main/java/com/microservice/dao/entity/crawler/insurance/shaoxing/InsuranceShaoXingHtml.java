...
@Entity
@Table(name="insurance_shaoxing_html",indexes = {@Index(name = "index_insurance_shaoxing_html_taskid", columnList = "taskid")}) 
public class InsuranceShaoXingHtml extends IdEntity{
