...
@DynamicUpdate(true)
@DynamicInsert
@Table(name="maimai_friend_work_exps",indexes = {@Index(name = "index_maimai_friend_work_exps_taskid", columnList = "taskid")})
public class MaimaiFriendWorkExps extends IdEntity{
	...
	public String toString() {
		return "MaimaiFriendWorkExps [taskid=" + taskid + ", mm_id=" + mm_id + ", company=" + company
