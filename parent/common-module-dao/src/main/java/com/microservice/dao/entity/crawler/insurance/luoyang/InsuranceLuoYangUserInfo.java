...
@Entity
@Table(name = "insurance_luoyang_userinfo",indexes = {@Index(name = "index_insurance_luoyang_userinfo_taskid", columnList = "taskid")})
public class InsuranceLuoYangUserInfo extends IdEntity implements Serializable{
	...
	public InsuranceLuoYangUserInfo(String taskid, String birthday, String nation, String insuredtime, String dw_num,
	...
	public InsuranceLuoYangUserInfo() {
		super();
	}
