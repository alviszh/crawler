 ...
 * @description:
 * @author: sln 
 * @date: 2018年1月9日 上午10:03:21 
 */
public class NanYangService {
	public static void main(String[] args) {
		try {
			//先请求链接登录链接，获取图片验证码对象
			String url="http://www.hnylbx.com:33002/siq/indexsz.jsp?zoneCode=419900";
			...
			url="http://www.hnylbx.com:33002/siq/pages/security/result.jsp?s=0.9832108861612767";
