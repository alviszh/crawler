...
@Entity
@Table(name = "insurance_jiaozuo_yanglaoinfo",indexes = {@Index(name = "index_insurance_jiaozuo_yanglaoinfo_taskid", columnList = "taskid")})
public class InsuranceJiaoZuoYangLaoInfo extends IdEntity implements Serializable{
	...
	public InsuranceJiaoZuoYangLaoInfo(String category, String unit, String time, String base, String sign,
	...
	public InsuranceJiaoZuoYangLaoInfo() {
		super();
	}
	@Override
	public String toString() {
		return "InsuranceJiaoZuoYangLaoInfo [category=" + category + ", unit=" + unit + ", time=" + time + ", base="
