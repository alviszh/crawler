...
@Entity
@Table(name="housing_qinzhou_userinfo",indexes = {@Index(name = "index_housing_qinzhou_userinfo_taskid", columnList = "taskid")})
public class HousingFundQinZhouUserInfo extends IdEntity{
