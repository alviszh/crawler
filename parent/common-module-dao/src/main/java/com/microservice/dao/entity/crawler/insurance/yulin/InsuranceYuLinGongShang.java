...
@Entity
@Table(name = "insurance_yulin_gongshang",indexes = {@Index(name = "index_insurance_yulin_gongshang_taskid", columnList = "taskid")})
public class InsuranceYuLinGongShang extends IdEntity implements Serializable{
	...
	public InsuranceYuLinGongShang(String taskid, String companyname, String settlement_period, String fkdate,
	...
	public InsuranceYuLinGongShang() {
		super();
	}
