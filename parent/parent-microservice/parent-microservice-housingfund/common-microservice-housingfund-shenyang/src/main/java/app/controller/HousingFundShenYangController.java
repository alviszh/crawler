...
import app.service.HousingFundShenYangService;

@RestController
@Configuration
@RequestMapping("/housing/shenyang")
public class HousingFundShenYangController extends HousingBasicController{

	@Autowired
	private HousingFundShenYangService housingFundShenYangService;
	@Autowired
...
//			save(taskHousing);
			...
			housingFundShenYangService.login(messageLoginForHousing);
...
//			save(taskHousing);
			...
			housingFundShenYangService.getAllData(messageLoginForHousing);
