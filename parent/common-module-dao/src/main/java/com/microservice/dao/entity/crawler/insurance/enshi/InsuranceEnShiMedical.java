...
@Entity
@Table(name="insurance_enshi_medical",indexes = {@Index(name = "index_insurance_enshi_medical_taskid", columnList = "taskid")})
public class InsuranceEnShiMedical extends IdEntity{
	...
	public String toString() {
		return "InsuranceEnShiMedical [personalNum=" + personalNum + ", inDate=" + inDate + ", xz=" + xz
				+ ", moneyType=" + moneyType + ", payType=" + payType + ", base=" + base + ", payNow=" + payNow
				+ ", personalMoney=" + personalMoney + ", getFlag=" + getFlag + ", getDate=" + getDate + ", sendFlag="
				+ sendFlag + ", taskid=" + taskid + "]";
	}
