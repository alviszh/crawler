...
@Entity
@Table(name = "insurance_leshan_shengyu")
public class InsuranceLeShanShengYu extends IdEntity implements Serializable{
	...
	public InsuranceLeShanShengYu(String taskid, String dwname, String paydate, String cardinality, String dwpay,
