 ...
 */
@Entity
@Table(name="insurance_weifang_persion",indexes = {@Index(name = "index_insurance_weifang_persion_taskid", columnList = "taskid")})
public class InsuranceWeiFangPersion extends IdEntity {
	...
	public String toString() {
		return "InsuranceWeiFangPersion [rnum=" + rnum + ", beginMonth=" + beginMonth + ", endMonth=" + endMonth
