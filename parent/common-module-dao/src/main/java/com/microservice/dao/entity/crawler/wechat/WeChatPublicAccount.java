...
@Entity
@Table(name="wechat_public_account",indexes = {@Index(name = "index_wechat_public_account_taskid", columnList = "taskid")})
public class WeChatPublicAccount extends IdEntity{
