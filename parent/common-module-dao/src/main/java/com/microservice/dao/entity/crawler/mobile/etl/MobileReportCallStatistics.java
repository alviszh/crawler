...
@Entity
@Table(name="mobile_report_call_statistics",indexes = {@Index(name = "index_mobile_report_call_statistics_taskid", columnList = "taskId")})


public class MobileReportCallStatistics extends IdEntity implements Serializable{
	...
	public String toString() {
		return "MobileReportCallStatistics [taskId=" + taskId + ", interactMth=" + interactMth + ", interactCnt="
				+ interactCnt + ", interactTime=" + interactTime + ", dialTime=" + dialTime + ", contractsCnt="
				+ contractsCnt + ", mutualnumberCnt=" + mutualnumberCnt + ", dialCnt=" + dialCnt + ", dialedCnt="
				+ dialedCnt + ", callFee=" + callFee + "]";
	}
