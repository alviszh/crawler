...
@Entity
@Table(name="insurance_shaoxing_unemployment",indexes = {@Index(name = "index_insurance_shaoxing_unemployment_taskid", columnList = "taskid")}) 
public class InsuranceShaoXingUnemployment extends IdEntity{
