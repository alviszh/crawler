...
@Entity
@Table(name = "insurance_luoyang_shiyeinfo",indexes = {@Index(name = "index_insurance_luoyang_shiyeinfo_taskid", columnList = "taskid")})
public class InsuranceLuoYangShiYeInfo extends IdEntity implements Serializable{
	...
	public InsuranceLuoYangShiYeInfo(String taskid, String abstracts, String total, String pay_num, String gr_pay,
	...
	public InsuranceLuoYangShiYeInfo() {
		super();
	}
	@Override
