...
@RestController  
@Configuration
@RequestMapping("/insurance/enshi")
public class InsuranceEnShiController {

	@Autowired  
	private InsuranceEnShiCommonService insuranceEnShiCommonService;
	@Autowired
	...
	public TaskInsurance login(@RequestBody InsuranceRequestParameters insuranceRequestParameters){
		...
		tracer.addTag("InsuranceEnShiController login", insuranceRequestParameters.getTaskId());
		//通过taskid查出对应表中的数据
		TaskInsurance taskInsurance = taskInsuranceRepository.findByTaskid(insuranceRequestParameters.getTaskId());
//	    taskInsurance = insuranceService.changeLoginStatusDoing(taskInsurance);
//		try {
//			insuranceEnShiCommonService.login(insuranceRequestParameters,taskInsurance);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
	...
	public TaskInsurance crawler(@RequestBody InsuranceRequestParameters insuranceRequestParameters) throws Exception{
		...
		tracer.addTag("InsuranceEnShiController crawler", insuranceRequestParameters.getTaskId());
...
//		}else{
//			taskInsurance = insuranceService.changeLoginStatusDoing(taskInsurance);
//			insuranceEnShiCommonService.getAllData(insuranceRequestParameters,taskInsurance);	
//		}
