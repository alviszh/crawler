...
@Entity
@Table(name = "insurance_jiyuan_shiyeinfo",indexes = {@Index(name = "index_insurance_jiyuan_shiyeinfo_taskid", columnList = "taskid")})
public class InsuranceJiYuanShiYeInfo extends IdEntity implements Serializable{
	...
	public InsuranceJiYuanShiYeInfo(String taskid, String abstracts, String total, String pay_num, String gr_pay,
	...
	public InsuranceJiYuanShiYeInfo() {
		super();
	}
	@Override
