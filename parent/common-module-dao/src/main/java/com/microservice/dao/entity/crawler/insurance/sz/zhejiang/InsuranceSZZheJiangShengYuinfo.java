...
@Entity
@Table(name = "insurance_sz_zhejiang_shengyuinfo",indexes = {@Index(name = "index_insurance_sz_zhejiang_shengyuinfo_taskid", columnList = "taskid")})
public class InsuranceSZZheJiangShengYuinfo extends IdEntity{
	...
	public InsuranceSZZheJiangShengYuinfo(String taskid, String month, String paybase, String perpaymoney,
	...
	public InsuranceSZZheJiangShengYuinfo() {
		super();
	}
	@Override
