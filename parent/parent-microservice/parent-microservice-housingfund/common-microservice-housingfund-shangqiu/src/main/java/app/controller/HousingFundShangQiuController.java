...
import app.service.HousingFundShangQiuService;


@RestController  
@Configuration
@RequestMapping("/housing/shangqiu")
public class HousingFundShangQiuController extends HousingBasicController{
	@Autowired
	private TracerLog tracer;
	@Autowired
	private HousingFundShangQiuService housingFundShangqiuService;
	...
	public ResultData<TaskHousing> housingFundLogin(@RequestBody MessageLoginForHousing messageLoginForHousing) throws Exception {
		...
		save(taskHousing);
//		
		housingFundShangqiuService.login(messageLoginForHousing, taskHousing);
	...
	public ResultData<TaskHousing> housingFundCrawler(@RequestBody MessageLoginForHousing messageLoginForHousing) {
		...
		save(taskHousing);
		housingFundShangqiuService.crawler(messageLoginForHousing, taskHousing);
		result.setData(taskHousing);
		return result;
	}
