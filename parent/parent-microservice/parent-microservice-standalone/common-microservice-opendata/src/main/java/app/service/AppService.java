...
//		List<Product> list = productRepository.findByProductStatusOrderById(ProductStatus.Online);
	...
	public Map<String, Object> requestnoticeurl(String url,Long appProductListId,String request_body_param,String param) {
		...
		try {
			result = HttpUtil.sendPostHttp(url+url_param, request_body_param,map);
