...
@DynamicUpdate(true)
@DynamicInsert
@Table(name = "housing_xiangyang_userinfo" ,indexes = {@Index(name = "index_housing_xiangyang_userinfo_taskid", columnList = "taskid")})
public class HousingXiangyangUserInfo extends IdEntity {
	...
	public HousingXiangyangUserInfo(String taskid, String xingming, String csny, String xingbie, String zjlx, String zjhm,
	...
	public HousingXiangyangUserInfo() {
		super();
