package test.housingfund.taiyuan;
...
//			cookie =  loginNew(webClient, "142232198909127507", "Qgq15268122576");
...
//			 getPay(webClient);
	...
	public static String loginNew(WebClient webClient, String username, String password) throws Exception {

		String url = "http://zfgjjwt.taiyuan.gov.cn:12329/wt-web/grlogin";
...
//				String inputuserjymtemp = JOptionPane.showInputDialog("请输入验证码……");
	...
	private static void getUserInfo() throws Exception {
		...
		HousingTaiyuanUserInfo housingTaiyuanUserInfo = new HousingTaiyuanUserInfo("", xingming, csny, xingbie, zjlx,
				zjhm, sjhm, gddhhm, yzbm, jtysr, jtzz, hyzk, dkqk, grzh, grzhzt, grzhye, djrq, dwmc, jcbl, grjcjs, yjce,
				grckzhkhyhmc, grckzhhm);

		JSONArray jsonObject1 = JSONArray.fromObject(housingTaiyuanUserInfo);
...
//		String url = "http://zfgjjwt.taiyuan.gov.cn:12329/wt-web/jcr/jcrkhxxcx_mh.service";
		String url = "http://zfgjjwt.taiyuan.gov.cn:12329/wt-web/pages/gr_/gr_jcrmh_.html";		
		...
		Map<String, String> map = new HashMap<>();
		map.put("Cookie", "SESSION=f5909ef9-b6fc-4284-9ed9-801a681afe2e; token=7d4d2f1db4564d3893134ca5aaa5ae77; BSFIT_6uw4n=; X-BR-AntiSpider-Status=1; BR_VAL_VID=3; BR_VAL_PASSCODE=GXy5cZc-S7rnz7X-5iRwZJlaPWiCB8paSZ2RX0cc7yoq9kPrKOabLUhw4i37H_y1iL-W8eAld6fdwQs-63ODKPtwcxnf4w4J__S2PAYQ5IXIYi2PuoOYAquP57K9yludYeD7S9tUnfZzT7HivgYUeWphzQy3pAkE");
...
//				webClient.waitForBackgroundJavaScript(30000);
				...
				System.out.println("login-------------" + login);
				if (!login.contains("太原市公积金个人网厅登录页")) {
					System.out.println("=================+成功");
				} else {
					System.out.println("=================+失败");
				}
