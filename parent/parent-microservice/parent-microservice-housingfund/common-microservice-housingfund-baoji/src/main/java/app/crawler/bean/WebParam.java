...
public class WebParam<T> {
	...
	private HousingBaojiUserInfo housingBaojiUserInfo;
	...
	public HousingBaojiUserInfo getHousingBaojiUserInfo() {
		return housingBaojiUserInfo;
	}

	public void setHousingBaojiUserInfo(HousingBaojiUserInfo housingBaojiUserInfo) {
		this.housingBaojiUserInfo = housingBaojiUserInfo;
	}
