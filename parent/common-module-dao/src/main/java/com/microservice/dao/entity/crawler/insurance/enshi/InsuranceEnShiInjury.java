...
@Entity
@Table(name="insurance_enshi_injury",indexes = {@Index(name = "index_insurance_enshi_injury_taskid", columnList = "taskid")})
public class InsuranceEnShiInjury extends IdEntity{
	...
	public String toString() {
		return "InsuranceEnShiInjury [personalNum=" + personalNum + ", inDate=" + inDate + ", moneyType=" + moneyType
