...
import app.service.HousingFundChiFengCommonService;


@RestController
@Configuration  
@RequestMapping("/housing/chifeng")
public class HousingFundChiFengController  extends HousingBasicController{

	@Autowired
	private HousingFundChiFengCommonService housingFundChiFengCommonService;
	@Autowired
...
//		save(taskHousing);
	   ...
	   taskHousing = housingFundChiFengCommonService.login(messageLoginForHousing);
...
//		save(taskHousing);
		taskHousing =housingFundChiFengCommonService.getAllData(messageLoginForHousing);
