 ...
 */
@Entity
@Table(name = "insurance_luohe_bear" ,indexes = {@Index(name = "index_insurance_luohe_bear_taskid", columnList = "taskid")})
public class InsuranceLuoheBear extends IdEntity implements Serializable{
	

	/**
	 * 
	 */
	private static final long serialVersionUID = 5212952197865069889L;
	...
	public InsuranceLuoheBear(String taskid, String plan_month, String impose_month, String pay_num, String dw_pay,
