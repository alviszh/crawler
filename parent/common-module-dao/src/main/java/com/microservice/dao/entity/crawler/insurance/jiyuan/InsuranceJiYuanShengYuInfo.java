...
@Entity
@Table(name = "insurance_jiyuan_shengyuinfo",indexes = {@Index(name = "index_insurance_jiyuan_shengyuinfo_taskid", columnList = "taskid")})
public class InsuranceJiYuanShengYuInfo extends IdEntity implements Serializable{
	...
	public InsuranceJiYuanShengYuInfo(String taskid, String abstracts, String total, String pay_num, String gr_pay,
	...
	public InsuranceJiYuanShengYuInfo() {
		super();
	}
	@Override
