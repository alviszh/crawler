...
import app.service.HousingFundHuaiBeiService;


@RestController  
@Configuration
@RequestMapping("/housing/huaibei")
public class HousingFundHuaiBeiController extends HousingBasicController{
	@Autowired
	private TracerLog tracer;
	@Autowired
	private HousingFundHuaiBeiService housingFundHuaiBeiService;
	...
	public ResultData<TaskHousing> housingFundCrawler(@RequestBody MessageLoginForHousing messageLoginForHousing) {
		...
		housingFundHuaiBeiService.crawler(messageLoginForHousing, taskHousing);
