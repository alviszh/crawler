...
public class TestLogin2 {
	...
	public static void main(String[] args) throws Exception {
		...
		String loginUrl= "http://218.95.230.61/wt-web/grlogin";
		...
		HtmlImage image =page2.getFirstByXPath("//img[@id='captcha_img']");
		String imageName = UUID.randomUUID() + ".jpg";
		File file = new File("D:\\img\\"+imageName);
		image.saveAs(file);
	

		HtmlTextInput username = (HtmlTextInput)page2.getFirstByXPath("//input[@id='username']");

		
		HtmlPasswordInput password = (HtmlPasswordInput)page2.getFirstByXPath("//input[@id='in_password']");	
		HtmlTextInput code = (HtmlTextInput)page2.getFirstByXPath("//input[@id='captcha']");		
		HtmlButtonInput button = (HtmlButtonInput)page2.getFirstByXPath("//input[@id='gr_login']");
		...
		code.setText(input);
		username.setText("630103199102270822");
		password.setText("8200549wyp");
