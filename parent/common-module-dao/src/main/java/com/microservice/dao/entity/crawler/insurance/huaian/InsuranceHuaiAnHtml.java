...
@Entity
@Table(name="insurance_huaian_html",indexes = {@Index(name = "index_insurance_huaian_html_taskid", columnList = "taskid")}) 
public class InsuranceHuaiAnHtml extends IdEntity{
