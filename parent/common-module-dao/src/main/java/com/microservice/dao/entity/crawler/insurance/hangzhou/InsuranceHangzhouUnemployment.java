 ...
 */
@Entity
@Table(name="insurance_hangzhou_unemployment",indexes = {@Index(name = "index_insurance_hangzhou_unemployment_taskid", columnList = "taskid")})
public class InsuranceHangzhouUnemployment extends IdEntity{
	...
	public String toString() {
		return "InsuranceHangzhouUnemployment [taskid=" + taskid +", payMonth=" + payMonth 
