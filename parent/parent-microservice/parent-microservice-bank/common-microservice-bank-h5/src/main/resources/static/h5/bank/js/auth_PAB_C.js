$('#myTab').find('li').find("a").click( function() {
    ...
    if(!$(this).parent().hasClass("active")&&$(this).parent().index()==1){
        ...
        $('#id_num,#ac_num').find('input').attr("disabled","disabled");
    ...
    if(!$(this).parent().hasClass("active")&&$(this).parent().index()==2){
        ...
        $('#id_num,#p_num').find('input').attr("disabled","disabled");
...
$("input[name='loginName']").bind('input propertychange', function() {
    ...
    else if($("#loginType").val().trim()=='CARD_NUM'){
...
$("input[name='password']").bind('input propertychange', function() {
    ...
    var regP = /^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{2,}$/;
...
$('.back-pw').click( function() {
    window.location.href ="https://bank.pingan.com.cn/ibp/bank/index.html#findPwd/findPassword/index"
});

$('.back-user').click( function() {
    window.location.href ="https://bank.pingan.com.cn/ibp/bank/index.html#findUserName/findName/index"
});

$('.ion-ios-help-outline').click( function() {
    window.location.href  = '/h5/bank/help/PINGAN.html';
});