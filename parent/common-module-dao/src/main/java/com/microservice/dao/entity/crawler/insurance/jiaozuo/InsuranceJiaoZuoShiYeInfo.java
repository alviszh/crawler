...
@Entity
@Table(name = "insurance_jiaozuo_shiyeinfo",indexes = {@Index(name = "index_insurance_jiaozuo_shiyeinfo_taskid", columnList = "taskid")})
public class InsuranceJiaoZuoShiYeInfo extends IdEntity implements Serializable{
	...
	public InsuranceJiaoZuoShiYeInfo(String category, String unit, String time, String base, String sign,
	...
	public InsuranceJiaoZuoShiYeInfo() {
		super();
	}
	@Override
	public String toString() {
		return "InsuranceJiaoZuoShiYeInfo [category=" + category + ", unit=" + unit + ", time=" + time + ", base="
