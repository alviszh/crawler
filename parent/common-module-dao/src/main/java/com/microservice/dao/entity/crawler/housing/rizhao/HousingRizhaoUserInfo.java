...
@DynamicUpdate(true)
@DynamicInsert
@Table(name = "housing_rizhao_userinfo")
public class HousingRizhaoUserInfo extends IdEntity {
	...
	public HousingRizhaoUserInfo(String taskid, String name, String bank, String idNum, String staffAccount,
