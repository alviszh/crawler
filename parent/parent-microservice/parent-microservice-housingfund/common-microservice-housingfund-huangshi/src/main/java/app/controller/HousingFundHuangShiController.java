...
import app.service.HousingFundHuangShiCommonService;


@RestController
@Configuration  
@RequestMapping("/housing/huangshi")
public class HousingFundHuangShiController extends HousingBasicController{

	@Autowired
	private HousingFundHuangShiCommonService housingFundHuangShiCommonService;
	@Autowired
	...
	public ResultData<TaskHousing> housingFundLogin(@RequestBody MessageLoginForHousing messageLoginForHousing) throws Exception {
		...
		housingFundHuangShiCommonService.login(messageLoginForHousing, taskHousing);
	...
	public ResultData<TaskHousing> housingFundCrawler(@RequestBody MessageLoginForHousing messageLoginForHousing) throws Exception {
		...
		housingFundHuangShiCommonService.crawler(messageLoginForHousing, taskHousing);
