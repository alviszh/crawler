...
@Entity
@Table(name="insurance_enshi_endowment",indexes = {@Index(name = "index_insurance_enshi_endowment_taskid", columnList = "taskid")})
public class InsuranceEnShiEndowment extends IdEntity{
	...
	public String toString() {
		return "InsuranceEnShiEndowment [personalNum=" + personalNum + ", inDate=" + inDate + ", moneyType=" + moneyType
