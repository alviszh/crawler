...
@Entity
@Table(name="insurance_tianjin_pension",indexes = {@Index(name = "index_insurance_tianjin_pension_taskid", columnList = "taskid")}) 
public class InsuranceTianjinPension extends IdEntity{
