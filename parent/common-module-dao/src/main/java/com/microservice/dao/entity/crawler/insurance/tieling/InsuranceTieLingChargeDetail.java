 ...
 * @description:
 * @author: sln 
 * @date: 2017年12月12日 下午4:02:45 
 */
@Entity
@Table(name = "insurance_tieling_chargedetail",indexes = {@Index(name = "index_insurance_tieling_chargedetail_taskid", columnList = "taskid")})
public class InsuranceTieLingChargeDetail extends IdEntity implements Serializable{
...
//	到账日期
	...
	public InsuranceTieLingChargeDetail() {
		super();
