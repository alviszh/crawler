...
import app.service.HousingFundQiqihaerService;



@RestController  
@Configuration
@RequestMapping("/housing/qiqihaer")
public class HousingFundQiqihaerController extends HousingBasicController{
	
	@Autowired
	private HousingFundQiqihaerService housingFundQiqihaerService;
	@Autowired
	...
	public ResultData<TaskHousing> housingFundLogin(@RequestBody MessageLoginForHousing messageLoginForHousing) throws Exception {
		...
		housingFundQiqihaerService.login(messageLoginForHousing, taskHousing);
...
//		taskHousing.setError_code(HousingfundStatusCodeEnum.HOUSING_CRAWLER_READ.getError_code());
//		save(taskHousing);
//		housingFundAnshanService.crawler(messageLoginForHousing, taskHousing);
//		
//		result.setData(taskHousing);
//		return result;
//	
