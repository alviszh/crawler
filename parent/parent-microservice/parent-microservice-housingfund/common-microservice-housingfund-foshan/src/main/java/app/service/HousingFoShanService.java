...
public class HousingFoShanService extends HousingBasicService implements ICrawler, ICrawlerLogin{
	...
	public TaskHousing login(MessageLoginForHousing messageLoginForHousing) {
		tracer.addTag("parser.HousingFoShanService.login.taskid", messageLoginForHousing.getTask_id());
	...
	public TaskHousing getAllData(MessageLoginForHousing messageLoginForHousing) {
		tracer.addTag("parser.HousingFoShanService.getAllData.taskid", messageLoginForHousing.getTask_id());
		TaskHousing taskHousing = findTaskHousing(messageLoginForHousing.getTask_id());
