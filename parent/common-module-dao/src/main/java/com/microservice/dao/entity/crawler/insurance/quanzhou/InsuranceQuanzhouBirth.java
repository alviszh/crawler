...
/**
 * @author zhangyongjie
 * @create 2017-09-21 16:24
 * @Desc
 */
@Entity
@Table(name = "insurance_quanzhou_birth",indexes = {@Index(name = "index_insurance_quanzhou_birth_taskid", columnList = "taskid")})
public class InsuranceQuanzhouBirth extends IdEntity {
    ...
    public InsuranceQuanzhouBirth() {
    }

    public InsuranceQuanzhouBirth(String taskid, String prepareMonthly, String unitPaymentAmount, String socialInsuranceBase, String orgPayRatio) {
        this.taskid = taskid;
        this.prepareMonthly = prepareMonthly;
        this.unitPaymentAmount = unitPaymentAmount;
        this.socialInsuranceBase = socialInsuranceBase;
