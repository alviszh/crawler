...
@Entity
@Table(name="insurance_haikou_medical",indexes = {@Index(name = "index_insurance_haikou_medical_taskid", columnList = "taskid")})
public class InsuranceHaiKouMedical extends IdEntity{
	...
	public String toString() {
		return "InsuranceHaiKouMedical [company=" + company + ", status=" + status + ", datea=" + datea + ", base="
