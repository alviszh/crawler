...
import app.service.HousingFundZhuMaDianCommonService;

@RestController
@Configuration  
@RequestMapping("/housing/zhumadian")
public class HousingFundZhuMaDianController extends HousingBasicController{

	@Autowired
	private HousingFundZhuMaDianCommonService housingFundZhuMaDianCommonService;
	@Autowired
...
//		save(taskHousing);
		...
		housingFundZhuMaDianCommonService.login(messageLoginForHousing);
...
//		save(taskHousing);
		...
		housingFundZhuMaDianCommonService.getAllData(messageLoginForHousing);
