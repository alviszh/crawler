...
@Entity
@Table(name="mobile_report_contracts_statistics_six_month",indexes = {@Index(name = "index_mobile_report_contracts_statistics_six_month_taskid", columnList = "taskId")})

public class MobileReportContactsStatisticsSixMonth extends IdEntity implements Serializable{
	...
	public String toString() {
		return "MobileReportContractsStatisticsSixMonth [taskId=" + taskId + ", rankNum=" + rankNum + ", peerNumber="
