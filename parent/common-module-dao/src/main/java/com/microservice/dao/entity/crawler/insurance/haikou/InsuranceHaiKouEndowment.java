...
@Entity
@Table(name="insurance_haikou_endowment",indexes = {@Index(name = "index_insurance_haikou_endowment_taskid", columnList = "taskid")})
public class InsuranceHaiKouEndowment extends IdEntity{
	...
	public String toString() {
		return "InsuranceHaiKouEndowment [company=" + company + ", status=" + status + ", datea=" + datea + ", base="
