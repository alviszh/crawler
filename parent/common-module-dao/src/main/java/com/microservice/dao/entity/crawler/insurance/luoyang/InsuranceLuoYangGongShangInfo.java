package com.microservice.dao.entity.crawler.insurance.luoyang;
...
@Entity
@Table(name = "insurance_luoyang_gongshanginfo",indexes = {@Index(name = "index_insurance_luoyang_gongshanginfo_taskid", columnList = "taskid")})
public class InsuranceLuoYangGongShangInfo extends IdEntity implements Serializable{
	...
	public InsuranceLuoYangGongShangInfo(String taskid, String abstracts, String total, String pay_num, String gr_pay,
	...
	public InsuranceLuoYangGongShangInfo() {
		super();
	}
	@Override
