...
//		System.out.println("登陆成功后的页面  ====》》"+loggedPage.getWebResponse().getContentAsString());
		 String loginUrl4 = "http://58.59.38.82:8080/rzwscx/zfbzgl/zfbzsq/login_hidden.jsp";
		         
		WebRequest webRequest4 = new WebRequest(new URL(loginUrl4), HttpMethod.POST);	
		String requestBody="cxyd=0&cxydmc=0&dbname=gjjmx9&dlfs=01&sfzh=371121199109191211&password=053228&yzm="+input;
