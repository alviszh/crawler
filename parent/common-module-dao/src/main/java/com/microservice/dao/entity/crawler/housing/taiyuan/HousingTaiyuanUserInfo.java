package com.microservice.dao.entity.crawler.housing.taiyuan;
...
@DynamicUpdate(true)
@DynamicInsert
@Table(name = "housing_taiyuan_userinfo" ,indexes = {@Index(name = "index_housing_taiyuan_userinfo_taskid", columnList = "taskid")})
public class HousingTaiyuanUserInfo extends IdEntity {
	...
	public HousingTaiyuanUserInfo(String taskid, String xingming, String csny, String xingbie, String zjlx, String zjhm,
