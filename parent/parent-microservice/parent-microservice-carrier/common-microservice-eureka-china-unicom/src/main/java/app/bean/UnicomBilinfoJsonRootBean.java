...
public class UnicomBilinfoJsonRootBean {
	...
	private UnicomBilinfoResult result;
	...
	public void setResult(UnicomBilinfoResult result) {
		this.result = result;
	}

	public UnicomBilinfoResult getResult() {
		return result;
	}
