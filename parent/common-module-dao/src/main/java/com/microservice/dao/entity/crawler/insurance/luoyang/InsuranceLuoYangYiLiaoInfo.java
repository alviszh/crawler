...
@Entity
@Table(name = "insurance_luoyang_yiliaoinfo",indexes = {@Index(name = "index_insurance_luoyang_yiliaoinfo_taskid", columnList = "taskid")})
public class InsuranceLuoYangYiLiaoInfo extends IdEntity implements Serializable{
	...
	public InsuranceLuoYangYiLiaoInfo(String taskid, String abstracts, String total, String pay_num, String gr_pay,
	...
	public InsuranceLuoYangYiLiaoInfo() {
		super();
	}
	@Override
