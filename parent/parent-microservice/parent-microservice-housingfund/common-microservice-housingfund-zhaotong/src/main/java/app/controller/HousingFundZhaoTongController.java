...
import app.service.HousingFundZhaoTongService;


@RestController  
@Configuration
@RequestMapping("/housing/zhaotong")
public class HousingFundZhaoTongController extends HousingBasicController{
	@Autowired
	private TracerLog tracer;
	@Autowired
	private HousingFundZhaoTongService housingFundZhaoTongService;
	...
	public ResultData<TaskHousing> housingFundCrawler(@RequestBody MessageLoginForHousing messageLoginForHousing) {
		...
		housingFundZhaoTongService.crawler(messageLoginForHousing, taskHousing);
