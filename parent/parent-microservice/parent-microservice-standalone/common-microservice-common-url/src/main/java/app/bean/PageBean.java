...
public class PageBean {
	...
	//正文  返回值（不带标签的正文）
	private String content_return2;
	//正文  返回值（时间）
	private String time;
	//正文摘要  返回值
	...
	public String getContent_return2() {
		return content_return2;
	}

	public void setContent_return2(String content_return2) {
		this.content_return2 = content_return2;
	}
