...
@Entity
@Table(name="insurance_shaoguan_html",indexes = {@Index(name = "index_insurance_shaoguan_html_taskid", columnList = "taskid")})
public class InsuranceShaoGuanHtml extends IdEntity{
