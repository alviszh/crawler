...
@Entity
@Table(name="insurance_beijing_injury")
public class InsuranceBeijingInjury extends IdEntity{
	...
	public String toString() {
		return "InsuranceBeijingInjury [payMonth=" + payMonth + ", payCardinality=" + payCardinality
