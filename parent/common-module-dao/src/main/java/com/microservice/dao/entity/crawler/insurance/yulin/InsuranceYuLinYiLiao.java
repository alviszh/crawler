...
@Entity
@Table(name = "insurance_yulin_yiliao",indexes = {@Index(name = "index_insurance_yulin_yiliao_taskid", columnList = "taskid")})
public class InsuranceYuLinYiLiao extends IdEntity implements Serializable{
	...
	public InsuranceYuLinYiLiao(String taskid, String companyname, String settlement_period, String fkdate,
