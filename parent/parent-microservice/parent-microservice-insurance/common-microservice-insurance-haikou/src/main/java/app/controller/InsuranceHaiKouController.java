...
@RestController  
@Configuration
@RequestMapping("/insurance/haikou")
public class InsuranceHaiKouController {

	@Autowired
	private InsuranceHaiKouCommonService insuranceHaiKouCommonService;
	@Autowired
	...
	public TaskInsurance login(@RequestBody InsuranceRequestParameters insuranceRequestParameters){
		...
		tracer.addTag("InsuranceHaiKouController login", insuranceRequestParameters.getTaskId());
		//通过taskid查出对应表中的数据
		TaskInsurance taskInsurance = taskInsuranceRepository.findByTaskid(insuranceRequestParameters.getTaskId());
//	    taskInsurance = insuranceService.changeLoginStatusDoing(taskInsurance);
//		try {
//			insuranceHaiKouCommonService.login(insuranceRequestParameters,taskInsurance);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
	...
	public TaskInsurance crawler(@RequestBody InsuranceRequestParameters insuranceRequestParameters) throws Exception{
		...
		tracer.addTag("InsuranceHaiKouController crawler", insuranceRequestParameters.getTaskId());
...
//		}else{
//			taskInsurance = insuranceService.changeLoginStatusDoing(taskInsurance);
//			insuranceHaiKouCommonService.getAllData(insuranceRequestParameters,taskInsurance);	
//		}
