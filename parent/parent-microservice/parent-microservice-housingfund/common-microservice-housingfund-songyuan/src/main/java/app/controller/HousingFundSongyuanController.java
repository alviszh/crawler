...
import app.service.HousingFundSongyuanService;



@RestController  
@Configuration
@RequestMapping("/housing/songyuan")
public class HousingFundSongyuanController extends HousingBasicController{
	
	@Autowired
	private TracerLog tracer;
	@Autowired
	private   HousingFundSongyuanService housingFundSongyuanService;
	...
	public ResultData<TaskHousing> housingFundLogin(@RequestBody MessageLoginForHousing messageLoginForHousing) throws Exception {
		...
		tracer.addTag("action.housingFund.dezhou.login.start",messageLoginForHousing.getTask_id());
		...
		housingFundSongyuanService.login(messageLoginForHousing, taskHousing);
	...
	public ResultData<TaskHousing> housingFundCrawler(@RequestBody MessageLoginForHousing messageLoginForHousing) {
		...
		save(taskHousing);
		housingFundSongyuanService.crawler(messageLoginForHousing, taskHousing);
		result.setData(taskHousing);
		return result;
	}
