...
@Entity
@Table(name = "telecom_qinghai_smsresult")
public class TelecomQingHaiSMSThremResult extends IdEntity {
	...
	public String toString() {
		return "TelecomQingHaiSMSThremResult [callarea=" + callarea + ", callphone=" + callphone + ", callareaother="
