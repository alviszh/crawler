...
@Entity
@Table(name="insurance_xingtai_pension",indexes = {@Index(name = "index_insurance_xingtai_pension_taskid", columnList = "taskid")})
public class InsuranceXingTaiPension extends IdEntity{
	...
	public String toString() {
		return "InsuranceXingTaiPension [year=" + year + ", paymentType=" + paymentType
