...
@Entity
@Table(name="insurance_shaoxing_maternity",indexes = {@Index(name = "index_insurance_shaoxing_maternity_taskid", columnList = "taskid")}) 
public class InsuranceShaoXingMaternity extends IdEntity{
