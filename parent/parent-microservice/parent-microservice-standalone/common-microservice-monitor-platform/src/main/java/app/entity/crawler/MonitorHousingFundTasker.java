 ...
 */
@Entity
@Table(name = "monitor_housingfund_tasker")
public class MonitorHousingFundTasker extends IdEntity implements Serializable {
	...
	public MonitorHousingFundTasker() {
		super();
	}
	...
	public MonitorHousingFundTasker(String name, String idnum, String city, String developer, String paramsjson,
