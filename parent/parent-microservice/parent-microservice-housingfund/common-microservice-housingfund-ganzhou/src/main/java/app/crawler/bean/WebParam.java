...
public class WebParam<T> {
	...
	private HousingGanZhouUserInfo housingGanZhouUserInfo;
	...
	public HousingGanZhouUserInfo getHousingGanZhouUserInfo() {
		return housingGanZhouUserInfo;
	}

	public void setHousingGanZhouUserInfo(HousingGanZhouUserInfo housingGanZhouUserInfo) {
		this.housingGanZhouUserInfo = housingGanZhouUserInfo;
	}
