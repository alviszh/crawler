...
@Entity
@Table(name = "insurance_luoyang_yanglaoinfo",indexes = {@Index(name = "index_insurance_luoyang_yanglaoinfo_taskid", columnList = "taskid")})
public class InsuranceLuoYangYangLaoInfo extends IdEntity implements Serializable{
	...
	public InsuranceLuoYangYangLaoInfo(String taskid, String abstracts, String total, String pay_num, String gr_pay,
	...
	public InsuranceLuoYangYangLaoInfo() {
		super();
	}
	@Override
