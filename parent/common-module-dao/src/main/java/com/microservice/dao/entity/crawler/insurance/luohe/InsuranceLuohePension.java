 ...
 */
@Entity
@Table(name = "insurance_luohe_pension" ,indexes = {@Index(name = "index_insurance_luohe_pension_taskid", columnList = "taskid")})
public class InsuranceLuohePension extends IdEntity implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -3792041703021033411L;
	...
	public InsuranceLuohePension(String taskid, String plan_month, String impose_month, String pay_num, String dw_pay,
