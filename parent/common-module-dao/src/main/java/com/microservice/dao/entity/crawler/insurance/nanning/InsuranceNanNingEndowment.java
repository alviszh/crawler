...
@Entity
@Table(name="insurance_nanning_emdowment",indexes = {@Index(name = "index_insurance_nanning_emdowment_taskid", columnList = "taskid")}) 
public class InsuranceNanNingEndowment extends IdEntity{
