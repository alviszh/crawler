...
//	        console.log("==" + dataConsumer.eq(5).text().indexOf("短信"));
//	        console.log("==" + dataConsumer.eq(5).text().indexOf("邮件"));
//	        console.log("==" + dataConsumer.eq(6).text());
...
function clear(){
	console.log("clear");
	$('input[id^="getType"]').prop('checked',false);
	$('input[id^="introduce"]').prop('checked',false);
}
