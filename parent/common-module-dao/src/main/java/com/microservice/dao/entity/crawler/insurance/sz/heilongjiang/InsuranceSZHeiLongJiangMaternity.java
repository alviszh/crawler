...
@Entity
@Table(name="insurance_sz_heilongjiang_maternity",indexes = {@Index(name = "index_insurance_sz_heilongjiang_maternity_taskid", columnList = "taskid")}) 
public class InsuranceSZHeiLongJiangMaternity extends IdEntity{
