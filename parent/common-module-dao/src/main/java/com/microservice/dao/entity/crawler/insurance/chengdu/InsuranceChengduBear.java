 ...
 */
@Entity
@Table(name = "insurance_chengdu_bear" ,indexes = {@Index(name = "index_insurance_chengdu_bear_taskid", columnList = "taskid")})
public class InsuranceChengduBear extends IdEntity {
	...
	public String toString() {
		return "InsuranceChengduBear [taskid=" + taskid + ", payMonth=" + payMonth + ", company=" + company
	...
	public InsuranceChengduBear(String taskid, String payMonth, String company, String payBase, String companyPay,
