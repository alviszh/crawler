...
import app.service.HousingFundTongLiaoCommonService;

@RestController
@Configuration  
@RequestMapping("/housing/tongliao")
public class HousingFundTongLiaoController extends HousingBasicController{

	@Autowired
	private HousingFundTongLiaoCommonService housingFundTongLiaoCommonService;
	@Autowired
...
//		save(taskHousing);
		...
		housingFundTongLiaoCommonService.login(messageLoginForHousing);
...
//		save(taskHousing);
		...
		housingFundTongLiaoCommonService.getAllData(messageLoginForHousing);
