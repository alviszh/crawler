package com.microservice.dao.entity.crawler.housing.zhuhai;
...
@DynamicUpdate(true)
@DynamicInsert
@Table(name  ="housing_zhuhai_userinfo")
public class HousingZhuHaiUserinfo  extends IdEntity implements Serializable {
