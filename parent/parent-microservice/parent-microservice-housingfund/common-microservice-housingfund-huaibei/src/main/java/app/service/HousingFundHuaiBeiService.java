...
public class HousingFundHuaiBeiService extends HousingBasicService{

	@Autowired
	private HousingFundHuaiBeiCommonService housingFundHuaiBeiCommonService;


	public void crawler(MessageLoginForHousing messageLoginForHousing, TaskHousing taskHousing) {
		housingFundHuaiBeiCommonService.crawler(messageLoginForHousing,taskHousing);
	}
