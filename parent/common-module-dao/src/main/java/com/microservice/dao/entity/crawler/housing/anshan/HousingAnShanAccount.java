...
@Entity
@Table(name="housing_anshan_account")
public class HousingAnShanAccount extends IdEntity{
	...
	public String toString() {
		return "HousingAnShanAccount [name=" + name + ", birth=" + birth + ", sex=" + sex + ", cardType=" + cardType
				+ ", cardNum=" + cardNum + ", phone=" + phone + ", num=" + num + ", code=" + code + ", familyMoney="
				+ familyMoney + ", addr=" + addr + ", marry=" + marry + ", loan=" + loan + ", accountNum=" + accountNum
				+ ", status=" + status + ", fee=" + fee + ", openDate=" + openDate + ", company=" + company
				+ ", companyNum=" + companyNum + ", ratio=" + ratio + ", base=" + base + ", monthPay=" + monthPay
				+ ", bank=" + bank + ", personalNum=" + personalNum + ", taskid=" + taskid + "]";
	}
