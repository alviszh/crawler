...
public class WebParam<T> {
	...
	private HousingTaianUserInfo housingTaianUserInfo;
	...
	public HousingTaianUserInfo getHousingTaianUserInfo() {
		return housingTaianUserInfo;
	}

	public void setHousingTaianUserInfo(HousingTaianUserInfo housingTaianUserInfo) {
		this.housingTaianUserInfo = housingTaianUserInfo;
	}
