...
/**
 * 
 * 项目名称：common-microservice-search-task 类名称：SanWangUnit 类描述： 创建人：hyx
...
public class SanWangUnit {
	...
	public static String getIpByDNS(String dns) throws Exception {
		InetAddress addresses = InetAddress.getByName(dns);
