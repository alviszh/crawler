...
@Entity
@Table(name="insurance_nanyang_html",indexes = {@Index(name = "index_insurance_nanyang_html_taskid", columnList = "taskid")}) 
public class InsuranceNanYangHtml extends IdEntity{
