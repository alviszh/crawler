...
import app.service.InsuranceHuaiAnCommonService;
...
@RestController  
@Configuration
@RequestMapping("/insurance/huaian")
public class InsuranceHuaiAnController {
   
	@Autowired
	private InsuranceHuaiAnCommonService insuranceHuaiAnCommonService;
	@Autowired
...
//		try {
//			insuranceHuaiAnCommonService.login(insuranceRequestParameters,taskInsurance);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
...
//		}else{
//			taskInsurance = insuranceService.changeLoginStatusDoing(taskInsurance);
//			insuranceHuaiAnCommonService.getAllData(insuranceRequestParameters,taskInsurance);	
//		}
