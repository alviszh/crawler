 ...
 * @version
 */
public class LianTongLoginByViSMSSelenuim {
...
//		driver.findElement(By.id("userPwd")).sendKeys("211314");
		...
		wait = new FluentWait<WebDriver>(driver).withTimeout(20, TimeUnit.SECONDS).pollingEvery(20, TimeUnit.SECONDS)
		...
		try {
			...
			WebElement SMSSecond_button = wait.until(new Function<WebDriver, WebElement>() {
			...
			SMSSecond_button.click();
			String valicodeStr2 = JOptionPane.showInputDialog("请输入第二次验证码：");

			driver.findElement(By.id("input")).sendKeys(valicodeStr2.toString());
			...
			driver.findElement(By.xpath("//*[@id='searchTime']/ul/li[2]")).click();
