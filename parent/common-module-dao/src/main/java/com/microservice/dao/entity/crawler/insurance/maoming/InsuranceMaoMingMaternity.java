...
@Entity
@Table(name="insurance_maoming_maternity",indexes = {@Index(name = "index_insurance_maoming_maternity_taskid", columnList = "taskid")})
public class InsuranceMaoMingMaternity extends IdEntity{
