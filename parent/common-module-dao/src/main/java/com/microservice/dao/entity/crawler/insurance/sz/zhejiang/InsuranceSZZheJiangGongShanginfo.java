...
@Entity
@Table(name = "insurance_sz_zhejiang_gongshanginfo",indexes = {@Index(name = "index_insurance_sz_zhejiang_gongshanginfo_taskid", columnList = "taskid")})
public class InsuranceSZZheJiangGongShanginfo extends IdEntity{
	...
	public InsuranceSZZheJiangGongShanginfo(String taskid, String month, String paybase, String perpaymoney,
	...
	public InsuranceSZZheJiangGongShanginfo() {
		super();
	}
	@Override
