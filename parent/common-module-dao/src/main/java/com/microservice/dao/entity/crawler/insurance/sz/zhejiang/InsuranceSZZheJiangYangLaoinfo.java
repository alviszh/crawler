...
@Entity
@Table(name = "insurance_sz_zhejiang_yanglaoinfo",indexes = {@Index(name = "index_insurance_sz_zhejiang_yanglaoinfo_taskid", columnList = "taskid")})
public class InsuranceSZZheJiangYangLaoinfo extends IdEntity{
	...
	public InsuranceSZZheJiangYangLaoinfo(String taskid, String month, String paybase, String perpaymoney,
	...
	public InsuranceSZZheJiangYangLaoinfo() {
		super();
	}
	@Override
