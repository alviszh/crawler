...
public class InsuranceTieLingService extends InsuranceLinYiTemplateCommonService  implements InsuranceLogin{
	public static final Logger log = LoggerFactory.getLogger(InsuranceTieLingService.class);

	@Autowired
	private TaskInsuranceRepository taskInsuranceRepository;
	@Autowired
	private InsuranceTieLingCrawlerService insuranceTieLingCrawlerService;
	@Autowired
	...
	public TaskInsurance getAllData(InsuranceRequestParameters insuranceRequestParameters) {
		...
		try {
			Future<String> future=insuranceTieLingCrawlerService.getUserInfo(insuranceRequestParameters,taskInsurance);
...
//		如下是五种保险的爬取
		try {
			Future<String> future=insuranceTieLingCrawlerService.getPension(insuranceRequestParameters,taskInsurance);
		...
		try {
			Future<String> future=insuranceTieLingCrawlerService.getMedical(insuranceRequestParameters,taskInsurance);
		...
		try {
			Future<String> future=insuranceTieLingCrawlerService.getInjury(insuranceRequestParameters,taskInsurance);
		...
		try {
			Future<String> future=insuranceTieLingCrawlerService.getBear(insuranceRequestParameters,taskInsurance);
		...
		try {
			Future<String> future=insuranceTieLingCrawlerService.getUnemployment(insuranceRequestParameters,taskInsurance);
