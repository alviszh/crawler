...
public class TestLogin {
	...
	public static void main(String[] args) throws Exception {
		...
		String loginUrl = "https://www.sdwfhrss.gov.cn/rsjwz/self/login";		
		...
		HtmlPasswordInput password = (HtmlPasswordInput)page.getFirstByXPath("//input[@id='password1']");
		HtmlTextInput code = (HtmlTextInput)page.getFirstByXPath("//input[@name='yzm']");
		HtmlElement button = (HtmlElement)page.getFirstByXPath("//input[@name='button']");
...
//		
		...
		code.setText(input);
//
		username.setText("G19040754");
		password.setText("gl666124");
