...
public class HousingFundYiWuService extends HousingBasicService{

	@Autowired
	private HousingFundYiWuCommonService housingFundXuzhouCommonService;
	...
	public void crawler(MessageLoginForHousing messageLoginForHousing, TaskHousing taskHousing) {
		...
		housingFundXuzhouCommonService.getDetailInfo(messageLoginForHousing, taskHousing);
	}
