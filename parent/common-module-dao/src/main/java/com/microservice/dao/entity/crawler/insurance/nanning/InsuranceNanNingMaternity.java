...
@Entity
@Table(name="insurance_nanning_maternity",indexes = {@Index(name = "index_insurance_nanning_maternity_taskid", columnList = "taskid")}) 
public class InsuranceNanNingMaternity extends IdEntity{
