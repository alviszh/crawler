...
@Entity
@Table(name="insurance_maoming_endowment",indexes = {@Index(name = "index_insurance_maoming_endowment_taskid", columnList = "taskid")})
public class InsuranceMaoMingEndowment extends IdEntity{
