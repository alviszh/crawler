...
public class WebParam<T> {
	...
	private HousingSZHunanUserInfo housingSZHunanUserInfo;
	...
	public HousingSZHunanUserInfo getHousingSZHunanUserInfo() {
		return housingSZHunanUserInfo;
	}


	public void setHousingSZHunanUserInfo(HousingSZHunanUserInfo housingSZHunanUserInfo) {
		this.housingSZHunanUserInfo = housingSZHunanUserInfo;
	}
