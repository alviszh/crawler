...
public class HousingJiuquanFutureService extends HousingBasicService  implements ICrawlerLogin{
	...
	public TaskHousing loginTwo(MessageLoginForHousing messageLoginForHousing, TaskHousing taskHousing, Integer count)
		...
		tracer.addTag("HousingJiuquanFutureService.login", messageLoginForHousing.getTask_id());
		JSONObject jsonObject = JSONObject.fromObject(messageLoginForHousing);
		try {
			if (null != taskHousing) {
				WebParam webParam = housingJiuquanParse.login(messageLoginForHousing, taskHousing);

				if (null == webParam) {
					tracer.addTag("HousingJiuquanFutureService.login", messageLoginForHousing.getTask_id() + "登录页获取超时！");
					...
					tracer.addTag("HousingJiuquanFutureService.login--次数:" + count,
					...
					if (!html.contains("个人网厅登录页")) {
						...
						if (username_tip.contains("用户名无效")) {
							...
							tracer.addTag("HousingJiuquanFutureService.login--失败次数:" + count,
	...
	public TaskHousing getAllData(MessageLoginForHousing messageLoginForHousing) {
		...
		housingJiuquanInfoService.getUserInfo(taskHousing);
//		housingJiuquanInfoService.getMsg(taskHousing);
		return null;
	}
	...
	public TaskHousing login(MessageLoginForHousing messageLoginForHousing) {
		...
		try {
			...
			tracer.addTag("HousingJiuquanFutureService.login:" , messageLoginForHousing.getTask_id()+"---ERROR:"+e.toString());
			e.printStackTrace();
		}
