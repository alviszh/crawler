...
@Entity
@Table(name="insurance_shaoxing_endowment",indexes = {@Index(name = "index_insurance_shaoxing_endowment_taskid", columnList = "taskid")}) 
public class InsuranceShaoXingEndowment extends IdEntity{
