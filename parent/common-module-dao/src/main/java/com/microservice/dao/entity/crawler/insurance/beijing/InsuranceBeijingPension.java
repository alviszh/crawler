 ...
 */
@Entity
@Table(name="insurance_beijing_pension")
public class InsuranceBeijingPension extends IdEntity{
	...
	public String toString() {
		return "InsuranceBeijingPension [payMonth=" + payMonth + ", payType=" + payType + ", payCardinality="
