CREATE OR REPLACE FUNCTION "public"."telecom_fujian_etl"("taskid" text)
...
---用户基本信息
		...
		(
			...
			select 
				'telecom_fujian_userinfo:'|| a.id::TEXT as resource,
				a.taskid as task_id,
			...
			from 
				...
				on split_part(a.accountstatus,'：',2) = g.source_name
...
--缴费信息
		...
		(
			...
			select 
				'telecom_fujian_paymsg:' || a.id::text as resource,
				a.taskid as task_id,
				a.createtime as createtime,
...
--短信信息
		...
		(
			...
			select 
				'telecom_fujian_messagerhistory:' || a.id::text as resource,
				a.taskid as task_id,
				a.createtime as createtime,
...
--套餐（服务）信息
		...
		(
			...
			select
				'telecom_fujian_taocan_msg:'|| a.id::TEXT as resource,
				a.taskid as task_id,
				a.createtime as createtime,
...
--通话记录信息
		...
		(
			...
			select 
				'telecom_fujian_callhistory:'||a.id::text as resource,
				a.taskid as task_id,
				a.createtime as createtime,
...
--ALTER FUNCTION "public"."telecom_fujian_etl"("taskid" text) OWNER TO "TXDB";
;;