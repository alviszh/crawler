package com.microservice.dao.entity.crawler.housing.suining;
...
@Entity
@Table(name="housing_suining_userinfo",indexes = {@Index(name = "index_housing_suining_userinfo_taskid", columnList = "taskid")})
public class HousingSuiNingUserInfo extends IdEntity implements Serializable{
	...
	public String toString() {
		return "HousingSuiNingUserInfo [personalAccount=" + personalAccount + ", name=" + name + ", idCard=" + idCard
