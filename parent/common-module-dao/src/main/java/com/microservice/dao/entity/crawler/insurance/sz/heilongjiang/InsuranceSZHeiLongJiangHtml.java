...
@Entity
@Table(name="insurance_sz_heilongjiang_html",indexes = {@Index(name = "index_insurance_sz_heilongjiang_html_taskid", columnList = "taskid")}) 
public class InsuranceSZHeiLongJiangHtml extends IdEntity{
