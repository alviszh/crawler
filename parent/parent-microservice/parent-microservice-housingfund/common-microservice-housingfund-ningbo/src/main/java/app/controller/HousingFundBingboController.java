...
import app.service.HousingFundNingboService;

@RestController
@Configuration
@RequestMapping("/housing/ningbo")
public class HousingFundBingboController extends HousingBasicController{
	
	@Autowired
	private HousingFundNingboService housingFundNingboService;
	@Autowired
...
//		save(taskHousing);
		...
		housingFundNingboService.login(messageLoginForHousing);
...
//		save(taskHousing);
		...
		housingFundNingboService.getAllData(messageLoginForHousing);
