...
public class TelecomStarlevel extends IdEntity {
	...
	public TelecomStarlevel(String taskid, String custName, String membershipLevel, String growthpoint) {
		super();
		this.taskid = taskid;
		this.custName = custName;
		this.membershipLevel = membershipLevel;
