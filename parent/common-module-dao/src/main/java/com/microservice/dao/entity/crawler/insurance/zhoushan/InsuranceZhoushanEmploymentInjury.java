...
@Entity
@Table(name = "insurance_zhoushan_employment_injury")
public class InsuranceZhoushanEmploymentInjury extends InsuranceZhoushanBasicBean implements Serializable {
    //    "ysym": 201803,
    private String ysym;
    //            "acym": 201803,
    private String acym;
    ...
    public String toString() {
        return "InsuranceZhoushanEmploymentInjury{" +
                "ysym='" + ysym + '\'' +
                ", acym='" + acym + '\'' +
                ", ftym='" + ftym + '\'' +
                ", rewage='" + rewage + '\'' +
