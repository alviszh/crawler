 ...
 * @version
 */
public class LianTongLoginBySelenuim2 {
...
//		driver.close();
	...
	public static WebClient getSmSCode(WebClient webClient) throws Exception {
		...
		String url2 = "https://uac.10010.com/portal/Service/CheckNeedVerify?callback=jQuery172012727608617026065_"
				+ System.currentTimeMillis() + "&userName=" + "16630352768" + "&" + "pwdType=01&_="
		...
		String url_code = "https://uac.10010.com/portal/Service/SendCkMSG?callback=jQuery172003873314014258589_"
				+ System.currentTimeMillis() + "&req_time=" + System.currentTimeMillis() + "&mobile=" + "16630352768"
	...
	public static Object setphonecode(WebClient webClient) throws Exception {
		...
		// loginname.sendKeys("18532170235");
		//
		// driver.findElement(By.id("userPwd")).click();
		// driver.findElement(By.id("userPwd")).sendKeys("211314");

		loginname.sendKeys("16630352768");

		driver.findElement(By.id("userPwd")).click();
		driver.findElement(By.id("userPwd")).sendKeys("992325");
		...
		try {
			...
			url = "http://iservice.10010.com/e3/static/query/searchPerInfoUser/?_=" + System.currentTimeMillis();
			...
			for (Cookie sookie : cookies2) {
				
				System.out.println("=======cookies2======="+sookie.getName()+";;;;;"+sookie.getValue());
				driver.manage().addCookie(new org.openqa.selenium.Cookie(sookie.getName(), sookie.getValue()));
			}
			...
			Thread.sleep(2000);
			// driver.get("http://iservice.10010.com/e3/static/query/searchPerInfo/?_=1536371598034");
...
//			// webRequest.setCharset(Charset.forName("UTF-8"));
//			 searchPage = webClient3.getPage(webRequest);
//
//			System.out.println("searchPage : " + searchPage.getWebResponse().getContentAsString());
//
//			Set<Cookie> cookies2 = webClient3.getCookieManager().getCookies();
//
//			for (Cookie cookie : cookies2) {
//
//				System.out.println("webClient3 :  name:" + cookie.getName() + ":::::::::::::" + cookie.getValue());
//
//				webClient2.getCookieManager()
//						.addCookie(new Cookie("iservice.10010.com", cookie.getName(), cookie.getValue()));
//
//			}
	...
	public static String getCallThem(WebClient webClient) throws Exception {
		...
		String url = "http://iservice.10010.com/e3/static/query/callDetail?_="
				+ System.currentTimeMillis()
