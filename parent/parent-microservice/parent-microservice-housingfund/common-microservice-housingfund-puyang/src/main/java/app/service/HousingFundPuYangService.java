...
public class HousingFundPuYangService extends HousingBasicService  implements ICrawlerLogin{
	@Autowired
	private HousingFundPuYangCrawlerService housingFundPuYangCrawlerService;
	@Autowired
	...
	public TaskHousing login(MessageLoginForHousing messageLoginForHousing) {
		...
		try {
			String url="http://"+loginHost+"/wt-web/login";
			...
			if(null!=hPage){
				...
				url="http://"+loginHost+"/wt-web/login";
				...
				if(null!=hPage){
					...
					tracer.addTag("验证登录信息返回的结果页面是：", html);
	...
	public TaskHousing getAllData(MessageLoginForHousing messageLoginForHousing) {
		...
		try {
			Future<String> future=housingFundPuYangCrawlerService.getUserInfo(taskHousing);
		...
		try {
			Future<String> future=housingFundPuYangCrawlerService.getFlowInfo(taskHousing);
