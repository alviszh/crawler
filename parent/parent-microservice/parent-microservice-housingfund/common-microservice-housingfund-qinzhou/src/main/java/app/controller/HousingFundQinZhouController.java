...
import app.service.HousingFundQinZhouCommonService;

@RestController
@Configuration  
@RequestMapping("/housing/qinzhou")
public class HousingFundQinZhouController extends HousingBasicController{
	@Autowired
	private HousingFundQinZhouCommonService housingFundQinZhouCommonService;
	@Autowired
...
//		save(taskHousing);
		...
		housingFundQinZhouCommonService.login(messageLoginForHousing);
...
//		save(taskHousing);
		...
		housingFundQinZhouCommonService.getAllData(messageLoginForHousing);
