...
@Entity
@Table(name="housing_zhumadian_userinfo",indexes = {@Index(name = "index_housing_zhumadian_userinfo_taskid", columnList = "taskid")})
public class HousingFundZhuMaDianUserInfo extends IdEntity{
