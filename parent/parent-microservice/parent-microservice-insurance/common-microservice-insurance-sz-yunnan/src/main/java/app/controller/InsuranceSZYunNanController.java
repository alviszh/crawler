...
import app.service.InsuranceSZYunNanCommonService;
import app.service.InsuranceService;
import app.service.aop.InsuranceLogin;

@RestController  
@Configuration
@RequestMapping("/insurance/sz/yunnan")
public class InsuranceSZYunNanController {
	@Autowired
	private InsuranceSZYunNanCommonService insuranceSZYunNanCommonService;
	@Autowired
...
//		try {
//			insuranceSZYunNanCommonService.login(insuranceRequestParameters,taskInsurance);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
...
//		}else{
//			taskInsurance = insuranceService.changeLoginStatusDoing(taskInsurance);
//			insuranceSZYunNanCommonService.getAllData(insuranceRequestParameters,taskInsurance);	
//		}
