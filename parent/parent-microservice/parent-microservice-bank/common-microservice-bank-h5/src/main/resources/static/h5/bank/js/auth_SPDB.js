...
$('.back-pw').click( function() {
    window.location.href ="https://ebank.spdb.com.cn/nbper/ForgetCheckPwd.do?_viewReferer=topdefault,basic/ForgetCheckPwd"
});

$('.ion-ios-help-outline').click( function() {
    window.location.href  = '/h5/bank/help/SPD-DEBIT.html';
});