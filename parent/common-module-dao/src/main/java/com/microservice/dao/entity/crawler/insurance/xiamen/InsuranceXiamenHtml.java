 ...
 */
@Entity
@Table(name="insurance_xiamen_html",indexes = {@Index(name = "index_iinsurance_xiamen_html_taskid", columnList = "taskId")})
public class InsuranceXiamenHtml extends IdEntity implements Serializable{
