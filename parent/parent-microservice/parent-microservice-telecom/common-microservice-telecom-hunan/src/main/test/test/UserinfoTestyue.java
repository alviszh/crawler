	...
	public static void main(String[] args) {
		...
		try {
			...
			if (asXml.indexOf("登录失败") != -1) {
				...
				String wdzlurl = "http://hn.189.cn/webportal-wt/hnselfservice/billquery/queryBalanceRecord.parser?queryNumType=&accNbrType=80000045&queryFlag=1&queryNum=17388977090&queryMonth=201709";
