...
@Entity
@Table(name="insurance_zhaoqing_injury",indexes = {@Index(name = "index_insurance_zhaoqing_injury_taskid", columnList = "taskid")})
public class InsuranceZhaoQingInjury extends IdEntity{
