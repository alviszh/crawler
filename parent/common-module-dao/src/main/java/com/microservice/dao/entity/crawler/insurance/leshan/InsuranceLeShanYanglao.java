...
@Entity
@Table(name = "insurance_leshan_yanglao")
public class InsuranceLeShanYanglao extends IdEntity implements Serializable{
	...
	public InsuranceLeShanYanglao(String taskid, String dwname, String paydate, String cardinality, String dwpay,
