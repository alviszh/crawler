...
@Entity
@Table(name="insurance_haikou_injury",indexes = {@Index(name = "index_insurance_haikou_injury_taskid", columnList = "taskid")})
public class InsuranceHaiKouInjury extends IdEntity{
	...
	public String toString() {
		return "InsuranceHaiKouInjury [company=" + company + ", status=" + status + ", datea=" + datea + ", base="
