...
public class HousingFundDezhouService extends HousingBasicService{
	@Autowired
	private HousingFundDezhouCommonService housingFundDezhouCommonService;

	

	public void crawler(MessageLoginForHousing messageLoginForHousing, TaskHousing taskHousing) {
		housingFundDezhouCommonService.crawler(messageLoginForHousing,taskHousing);
	}
