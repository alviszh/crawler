...
@Entity
@Table(name="insurance_sz_heilongjiang_unemployment",indexes = {@Index(name = "index_insurance_sz_heilongjiang_unemployment_taskid", columnList = "taskid")}) 
public class InsuranceSZHeiLongJiangUnemployment extends IdEntity{
