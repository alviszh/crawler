...
import app.service.HousingFundFuzhou2Service;


@RestController  
@Configuration
@RequestMapping("/housing/fuzhou2")
public class HousingFundFuzhou2Controller extends HousingBasicController{
	@Autowired
	private TracerLog tracer;
	@Autowired
	private HousingFundFuzhou2Service housingFundYiChunService;
	...
	public ResultData<TaskHousing> housingFundLogin(@RequestBody MessageLoginForHousing messageLoginForHousing) throws Exception {
		...
		tracer.addTag("parser.housingFund.fuzhou2.login.start",messageLoginForHousing.getTask_id());
