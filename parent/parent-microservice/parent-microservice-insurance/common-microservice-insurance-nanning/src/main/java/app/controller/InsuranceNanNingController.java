...
@RestController  
@Configuration
@RequestMapping("/insurance/nanning")
public class InsuranceNanNingController {

//	@Autowired
//	private InsuranceNanNingCommonService insuranceNanNingCommonService;
	@Autowired
...
//	private InsuranceService insuranceService;
	...
	public TaskInsurance login(@RequestBody InsuranceRequestParameters insuranceRequestParameters){
		...
		tracer.addTag("InsuranceNanNingController login", insuranceRequestParameters.getTaskId());
		//通过taskid查出对应表中的数据
		TaskInsurance taskInsurance = taskInsuranceRepository.findByTaskid(insuranceRequestParameters.getTaskId());
//	    taskInsurance = insuranceService.changeLoginStatusDoing(taskInsurance);
//		try {
//			insuranceNanNingCommonService.login(insuranceRequestParameters,taskInsurance);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
	...
	public TaskInsurance crawler(@RequestBody InsuranceRequestParameters insuranceRequestParameters) throws Exception{
		...
		tracer.addTag("InsuranceNanNingController crawler", insuranceRequestParameters.getTaskId());
...
//		}else{
//			taskInsurance = insuranceService.changeLoginStatusDoing(taskInsurance);
//			insuranceNanNingCommonService.getAllData(insuranceRequestParameters,taskInsurance);	
//		}
