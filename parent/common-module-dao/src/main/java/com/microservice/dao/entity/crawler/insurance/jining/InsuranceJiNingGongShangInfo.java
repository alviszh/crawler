package com.microservice.dao.entity.crawler.insurance.jining;
...
@Entity
@Table(name="insurance_jining_gongshang_info")
public class InsuranceJiNingGongShangInfo extends IdEntity implements Serializable{
