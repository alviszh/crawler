...
@Entity
@Table(name = "insurance_zhoushan_unemployment")
public class InsuranceZhoushanUnemployment extends InsuranceZhoushanBasicBean implements Serializable {
    //    "ysym": 201803,
    private String ysym;
    //            "acym": 201803,
    private String acym;
    ...
    public String toString() {
        return "InsuranceZhoushanUnemployment{" +
                "ysym='" + ysym + '\'' +
                ", acym='" + acym + '\'' +
                ", ftym='" + ftym + '\'' +
                ", rewage='" + rewage + '\'' +
