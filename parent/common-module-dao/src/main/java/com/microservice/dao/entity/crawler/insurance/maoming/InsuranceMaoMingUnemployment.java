...
@Entity
@Table(name="insurance_maoming_unemployment",indexes = {@Index(name = "index_insurance_maoming_unemployment_taskid", columnList = "taskid")})
public class InsuranceMaoMingUnemployment extends IdEntity{
