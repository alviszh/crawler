 ...
 */
@Entity
@Table(name = "insurance_chengdu_pension" ,indexes = {@Index(name = "index_insurance_chengdu_pension_taskid", columnList = "taskid")})
public class InsuranceChengduPension extends IdEntity{
	...
	public String toString() {
		return "InsuranceChengduPension [taskid=" + taskid + ", payMonth=" + payMonth + ", company=" + company
	...
	public InsuranceChengduPension(String taskid, String payMonth, String company, String payBase, String companyPay,
	...
	public InsuranceChengduPension() {
		super();
