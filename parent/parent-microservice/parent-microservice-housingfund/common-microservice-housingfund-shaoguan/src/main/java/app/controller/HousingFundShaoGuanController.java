...
import app.service.HousingFundShaoGuanCommonService;

@RestController
@Configuration
@RequestMapping("/housing/shaoguan")
public class HousingFundShaoGuanController extends HousingBasicController{

	@Autowired
	private HousingFundShaoGuanCommonService housingFundShaoGuanCommonService;
	@Autowired
...
//			save(taskHousing);
			...
			housingFundShaoGuanCommonService.login(messageLoginForHousing);
...
//			save(taskHousing);
			...
			housingFundShaoGuanCommonService.getAllData(messageLoginForHousing);
