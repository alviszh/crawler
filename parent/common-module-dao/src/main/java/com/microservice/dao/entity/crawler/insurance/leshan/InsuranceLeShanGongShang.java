...
@Entity
@Table(name = "insurance_leshan_gongshang")
public class InsuranceLeShanGongShang extends IdEntity implements Serializable{
	...
	public InsuranceLeShanGongShang(String taskid, String dwname, String paydate, String cardinality, String dwpay,
	...
	public InsuranceLeShanGongShang() {
		super();
	}
