...
@Entity
@Table(name="mobile_report_call_statistics_six_month",indexes = {@Index(name = "index_mobile_report_call_statistics_six_month_taskid", columnList = "taskId")})


public class MobileReportCallStatisticsSixMonth extends IdEntity implements Serializable{
	...
	public String toString() {
		return "MobileReportCallStatisticsSixMonth [taskId=" + taskId + ", interactMth=" + interactMth
