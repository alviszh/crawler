...
@Entity
@Table(name="insurance_ningbo_lost",indexes = {@Index(name = "index_insurance_ningbo_lost_taskid", columnList = "taskid")}) 
public class InsuranceNingboLost extends IdEntity{
	...
	public String toString() {
		return "InsuranceNingboLost [taskid=" + taskid + ", payDate=" + payDate + ", insuranceBase=" + insuranceBase
