...
@DynamicUpdate(true)
@DynamicInsert
@Table(name = "housing_ganzhou_userinfo")
public class HousingGanZhouUserInfo extends IdEntity {
	...
	public HousingGanZhouUserInfo(String taskid, String username, String cardNum, String idNum, String fundNum,
