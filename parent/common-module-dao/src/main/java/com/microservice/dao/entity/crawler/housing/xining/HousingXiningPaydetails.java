package com.microservice.dao.entity.crawler.housing.xining;
...
@DynamicUpdate(true)
@DynamicInsert
@Table(name = "housing_xining_paydetails")
public class HousingXiningPaydetails extends IdEntity {
	...
	public HousingXiningPaydetails() {
		super();
		// TODO Auto-generated constructor stub
	}

	public HousingXiningPaydetails(String taskid, String jzrq, String gjhtqywlx, String fse, String fslxe, String grzhye,
