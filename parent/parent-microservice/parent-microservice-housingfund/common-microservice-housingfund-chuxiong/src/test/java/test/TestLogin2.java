...
public class TestLogin2 {
	...
	public static void main(String[] args) throws Exception {
		...
		String loginUrl= "http://www.qjzfgjj.com/website/trans/queryPer_login.jsp?txt=1#";
		HtmlPage page2 =  getHtml(loginUrl,webClient);
		webClient.getOptions().setJavaScriptEnabled(true);  
		webClient.waitForBackgroundJavaScript(20000);
		HtmlTextInput username = (HtmlTextInput)page2.getFirstByXPath("//input[@name='accnum']");
		
		HtmlTextInput certinum = (HtmlTextInput)page2.getFirstByXPath("//input[@name='certinum']");
		...
		HtmlElement button = (HtmlElement)page2.getFirstByXPath("//input[@id='sbt']");
