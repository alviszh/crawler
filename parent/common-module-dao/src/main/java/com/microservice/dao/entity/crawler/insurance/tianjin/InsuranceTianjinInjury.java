...
@Entity
@Table(name="insurance_tianjin_Injury",indexes = {@Index(name = "index_insurance_tianjin_Injury_taskid", columnList = "taskid")}) 
public class InsuranceTianjinInjury extends IdEntity{
