...
@DynamicUpdate(true)
@DynamicInsert
@Table(name = "wechat_flow_status" ,indexes = {@Index(name = "index_wechat_flow_status_taskid", columnList = "taskid")})
public class WeChatFlowStatus extends IdEntity implements Serializable{
	...
	public WeChatFlowStatus(String taskid, String description, String phase, String phase_status) {
		super();
		this.taskid = taskid;
		this.description = description;
		this.setPhase(phase);
