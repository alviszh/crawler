...
@Entity
@Table(name="mobile_report_consumption_six_month",indexes = {@Index(name = "index_mobile_report_consumption_six_month_taskid", columnList = "taskId")})

public class MobileReportConsumptionSixMonth extends IdEntity implements Serializable{
	...
	public String toString() {
		return "MobileReportConsumptionSixMonth [taskId=" + taskId + ", callPay=" + callPay + ", monthFlow=" + monthFlow
				+ ", netFlow=" + netFlow + ", rechangeAmount=" + rechangeAmount + "]";
	}	
}
