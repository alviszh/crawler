...
@Entity
@Table(name = "housing_siping_pay",indexes = {@Index(name = "index_housing_siping_pay_taskid", columnList = "taskid")})
public class HousingSiPingPay extends IdEntity implements Serializable {
	...
	public HousingSiPingPay(String taskid, String num, String rdate, String tq_money, String cr_money, String yu,
			String zai) {
		super();
		this.taskid = taskid;
		this.num = num;
