 ...
 */
@Entity
@Table(name = "insurance_nanchang_medical" ,indexes = {@Index(name = "index_insurance_nanchang_medical_taskid", columnList = "taskid")})
public class InsuranceNanchangMedical extends IdEntity {
	...
	public InsuranceNanchangMedical(String taskid, String personalNumber, String feePeriod, String paymentType, String onBills, String paymentBase, String unitPayment, String personalPayment, String totalMon) {
		this.taskid = taskid;
		this.personalNumber = personalNumber;
		this.feePeriod = feePeriod;
		this.paymentType = paymentType;
	...
	public InsuranceNanchangMedical() {
		super();
