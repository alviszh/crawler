...
@Entity
@Table(name="housing_chifeng_account",indexes = {@Index(name = "index_housing_chifeng_account_taskid", columnList = "taskid")})
public class HousingFundChiFengAccount extends IdEntity{
