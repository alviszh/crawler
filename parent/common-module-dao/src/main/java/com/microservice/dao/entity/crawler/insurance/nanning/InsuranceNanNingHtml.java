...
@Entity
@Table(name="insurance_nanning_html",indexes = {@Index(name = "index_insurance_nanning_html_taskid", columnList = "taskid")}) 
public class InsuranceNanNingHtml extends IdEntity{
