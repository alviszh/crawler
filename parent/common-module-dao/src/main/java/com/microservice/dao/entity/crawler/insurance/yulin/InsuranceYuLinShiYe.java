...
@Entity
@Table(name = "insurance_yulin_shiye",indexes = {@Index(name = "index_insurance_yulin_shiye_taskid", columnList = "taskid")})
public class InsuranceYuLinShiYe extends IdEntity implements Serializable{
	...
	public InsuranceYuLinShiYe(String taskid, String companyname, String settlement_period, String fkdate,
