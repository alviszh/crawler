...
@Entity
@Table(name = "insurance_leshan_shiye")
public class InsuranceLeShanShiYe extends IdEntity implements Serializable{
	...
	public InsuranceLeShanShiYe(String taskid, String dwname, String paydate, String cardinality, String dwpay,
