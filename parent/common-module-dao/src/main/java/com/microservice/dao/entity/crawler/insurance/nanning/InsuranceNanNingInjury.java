...
@Entity
@Table(name="insurance_nanning_injury",indexes = {@Index(name = "index_insurance_nanning_injury_taskid", columnList = "taskid")}) 
public class InsuranceNanNingInjury extends IdEntity{
