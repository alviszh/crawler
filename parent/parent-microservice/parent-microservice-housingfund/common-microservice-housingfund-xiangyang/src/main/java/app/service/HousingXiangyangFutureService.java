...
public class HousingXiangyangFutureService extends HousingBasicService implements ICrawlerLogin{
	...
	public TaskHousing loginTwo(MessageLoginForHousing messageLoginForHousing, TaskHousing taskHousing, Integer count)
		...
		tracer.addTag("HousingXiangyangFutureService.login", messageLoginForHousing.getTask_id());
		JSONObject jsonObject = JSONObject.fromObject(messageLoginForHousing);
		try {
			if (null != taskHousing) {
				WebParam webParam = housingXiangyangParse.login(messageLoginForHousing, taskHousing);

				if (null == webParam) {
					tracer.addTag("HousingXiangyangFutureService.login", messageLoginForHousing.getTask_id() + "登录页获取超时！");
					...
					tracer.addTag("HousingXiangyangFutureService.login--次数:" + count,
					...
					if (!html.contains("个人网厅登录页")) {
						...
						if (username_tip.contains("用户名无效")) {
							...
							tracer.addTag("HousingXiangyangFutureService.login--失败次数:" + count,
	...
	public TaskHousing getAllData(MessageLoginForHousing messageLoginForHousing) {
		...
		housingXiangyangInfoService.getUserInfo(taskHousing);
//		housingXiangyangInfoService.getPay(taskHousing);
		return null;
	}
	...
	public TaskHousing login(MessageLoginForHousing messageLoginForHousing) {
		...
		try {
			...
			tracer.addTag("HousingXiangyangFutureService.login:" , messageLoginForHousing.getTask_id()+"---ERROR:"+e.toString());
			e.printStackTrace();
		}
