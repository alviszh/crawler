...
/**
 * @description: 威海市公积金个人基本信息
 * @author: sln 
 * @date: 
 */
@Entity
@Table(name="housing_weihai_userinfo",indexes = {@Index(name = "index_housing_weihai_userinfo_taskid", columnList = "taskid")})
public class HousingWeiHaiUserInfo extends IdEntity implements Serializable {
