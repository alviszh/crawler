...
import app.service.executor.ExecutorExecutorBeanCrawlerService;
 ...
 */
@Component
public class ExecutorExecutorCrawlerService {

	@Autowired
	private ExecutorExecutorBeanCrawlerService executorExecutorBeanCrawlerService;
	...
	public void crawler(List<Integer> shixinid_list, HonestyTask honestyTask,String captchaId) {
		...
		for (Integer shixinid : shixinid_list) {
			...
			Future<String> future = executorExecutorBeanCrawlerService.getExecutroBreakPromise(captchaId, shixinid, code,
					honestyTask);
