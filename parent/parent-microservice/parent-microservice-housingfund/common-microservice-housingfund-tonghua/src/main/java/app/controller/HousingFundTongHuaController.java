...
import app.service.HousingFundTongHuaCommonService;

@RestController
@Configuration  
@RequestMapping("/housing/tonghua")   
public class HousingFundTongHuaController extends HousingBasicController{

	@Autowired
	private HousingFundTongHuaCommonService housingFundTongHuaCommonService;
	@Autowired
...
//			save(taskHousing);
			...
			housingFundTongHuaCommonService.login(messageLoginForHousing);
...
//			save(taskHousing);
			...
			housingFundTongHuaCommonService.getAllData(messageLoginForHousing);
